        ...
        <form action="" method="post" class="admin_form fl" enctype="multipart/form-data">
            <table>
                ...
                <tr>
					...
					<a href="<?php echo PATH; ?>images/xls/Admin_product.xls" style="text-decoration:underline"> <?php echo $this->Lang["CLICK_SAMPLE_CSV"];?> </a>
                    <td><label><?php echo $this->Lang["PRODUCT_IMPORT"]; ?><span>*</span></label></td>
                    <td><label>:</label></td>
                    <td>
                ...
                <tr>
                    <td></td>
                    <td></td>
                    <td><input type="submit" value="<?php echo $this->Lang['SUBMIT']; ?>" title="<?php echo $this->Lang['SUBMIT']; ?>" /><input type="reset" value="<?php echo $this->Lang['RESET']; ?>" onclick="javascript:window.location='<?php echo PATH; ?>admin/product-import.html'"/></td>

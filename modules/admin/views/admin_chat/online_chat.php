    ...
    <?php if(count($this->contacts_list)>0){?>
        ...
        <table class="list_table fl clr mt15">
            <tr>
               ...
               <?php /*  <th align="left" ><?php echo $this->Lang['CHT']; ?></th>
                */ ?>
            ...
            <?php $i=0; $first_item = $this->pagination->current_first_item;
                ...
                <td align="left" ><a href='<?php echo PATH."admin/view-conversation/".$u->sellerid."/".$u->from1.".html"; ?>'><?php echo $this->Lang['VIEW_DET']; ?></a></td>
                <td align="left"> 
 <script>
...
$('#em').text(''); 
                ...
                <table>
		            ...
		            <td><textarea class="TextArea" name="message" id="msg" cols=15 rows=10 /></textarea>
                        ...
                        <tr>
                             <td></td>
                             <td></td>
                             <td><input type="submit" value="<?php echo $this->Lang['SEND']; ?>" id="submit<?php echo $u->id; ?>"> <input type="reset" id="cancel" value="<?php echo $this->Lang['CANCEL']; ?>" onclick="javascript:window.location='<?php echo PATH; ?>admin/online-chat.html'" />
			     </td>
                        </tr>
                </table>
        </form>
  ...
  <td align="left"><?php echo $u->sent; ?></td>
               <?php /*  <td align="left"><?php //echo substr(ucfirst($u->message), 0,250); ?></td>
                */ ?>
                </tr>
            <?php $i++;} ?>   
        </table>

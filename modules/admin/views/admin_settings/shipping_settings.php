                        ...
                        <div class="mergent_det">
	                        <fieldset>
                            	<legend><?php echo $this->Lang["ARAMAX_ACC"]; ?></legend>   
			                        <table>
		                                <tr>
                                            <td style="width: 200px;"><label><?php echo $this->Lang['ACCTCOUNTRYCODE']; ?></label><span>*</span></td>
                                            <td><label>:</label></td>
		                                ...
		                                <tr>
                                            <td style="width: 200px;"><label><?php echo $this->Lang['ACCTENTITY']; ?></label><span>*</span></td>
                                            <td><label>:</label></td>
		                                ...
		                                <tr>
                                            <td style="width: 200px;"><label><?php echo $this->Lang['Lang['ACCTNUMBER']']; ?></label><span>*</span></td>
                                            <td><label>:</label></td>
                                        ...
                                        <tr>
                                            <td style="width: 200px;"><label><?php echo $this->Lang['PSWD']; ?></label><span>*</span></td>
                                            <td><label>:</label></td>

...
<?php /*<form action="" method="get" class="admin_form">
 ...
 /*********************** User today List Chart Start ************************/
    ...
    if(count($this->user_list)>0) {
            foreach($this->user_list as $user){
                if($user->login_type == 7 || $user->login_type ==1){
                 $NU++;                        
                }
...
var chart;
    $(document).ready(function() {
		...
		<?php } else { ?>
		 title: {
                text: "<?php echo $this->Lang['LST_THIRTY_DYS_WEB_CUS_CARE']; ?>"
            },
		<?php } ?>
            ...
            plotOptions: {
                ...
                series: [{
                name: "<?php echo $this->Lang['NEW_CUS_CARE']; ?>",
...
var chart;
    $(document).ready(function() {
        chart = new Highcharts.Chart({
            ...
            title: {
                text: "<?php echo $this->Lang['LST_TWELVE_MHS_WEB_CUS_CARE']; ?>"
            },
            subtitle: {
                text: ''
            },
            ...
            plotOptions: {
                ...
                series: [{
                name: "<?php echo $this->Lang['WEB_CUS_CARE']; ?>",
...
var chart;
    $(document).ready(function() {
        chart = new Highcharts.Chart({
            ...
            title: {
                text: "<?php echo $this->Lang['LST_TEN_YRS_WEB_CUS_CARE']; ?>"
            },
            subtitle: {
                text: ''
            },
...
$(document).ready(function() {
	chart = new Highcharts.Chart({
		...
		title: {
			text: "<?php echo $this->Lang['TOT_CUS_CARE_CUNT']; ?> "
		},
		...
		series: [{
			type: 'pie',
			name: "<?php echo $this->Lang['CUS_CARE_CUNT']; ?>",
			data: [
				["<?php echo $this->Lang['ADMIN_USER_CARE']; ?> ", <?php echo $admin_user; ?>]
    ...
    <div class="invest-cl">
      <div class="invest-cr">
        <div class="inves_marketing">
          <h3 class="market"><?php echo $this->Lang['WEB_CUS_CARE_DET']; ?></h3>
          <div class="invest-cl">
            <div class="invest-cr">
              <div class="invest-cm">
                    ...
                    <div class="invest-tl">
                      ...
                      <div class="trans_table_mid_tot">
                        ...
                        <div class="trans_table_mm_tot" >
                          <h3 class="market"><?php echo $this->Lang['USER_CARE_DET']; ?></h3>
            ...
            <tr>
            <td><a href="<?php  echo PATH; ?>admin/manage-customer-care.html"><?php echo $this->Lang['ADMIN_USER']; ?></a>  </td>
            ...
            <tr>
            <td><a href="<?php  echo PATH; ?>admin/manage-customer-care.html"><?php echo $this->Lang['TOT_CUS']; ?></a></td>
            <td><?php echo $y; ?></td>
            </tr>*/?>
            </table>
                        </div>
		...
		<div class="trans_table_mid_tot">
            ...
            <table width="100%" cellpadding="10" cellspacing="0">
            <tr>
            <th align="left"><?php echo $this->Lang['WEB_CUS_CARE']; ?> </th>
            <th align="left"><?php echo $this->Lang['COUNT']; ?> </th>
            </tr>
            <tr>
...
<div class="chart_1 fl">
    ...
    <li  id="userdate" class=" selected fl"> 
      <div class="tab1"></div>
      <div class="tab2" ><a  onclick="return User_date();" id="userdate"><?php echo $this->Lang['LST_THIRTY_DYS_WEB_CUS_CARE']; ?></a></div>
      <div class="tab3"></div>
    </li>
    <li class=" fl" id="usermonth">
      <div class="tab1"></div>
      <div class="tab2" ><a onclick="return User_month();"  id="usermonth"><?php echo $this->Lang['LST_TWELVE_MHS_WEB_CUS_CARE']; ?></a></div>
      <div class="tab3"></div>
    </li>
    
    <li class=" fl" id="useryear">
      <div class="tab1"></div>
      <div class="tab2" ><a onclick="return User_year();"  id="useryear"><?php echo $this->Lang['LST_TEN_YRS_WEB_CUS_CARE']; ?></a></div>
      <div class="tab3"></div>
    </li>
  </ul>
</div> 

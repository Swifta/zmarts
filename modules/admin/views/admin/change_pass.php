    ...
    <div class="content_middle">
        ...
        <form action="" method="post" class="admin_form">
            <table>
                ...
                <td><input name="cpassword" type="password" value="" size="30" placeholder="<?php echo $this->Lang["CONFIRM_PSWD"]; ?> " /><em><?php if(isset($this->form_error['cpassword'])){ echo $this->form_error["cpassword"]; }?></em></td>
                 <tr>
                    <td></td>

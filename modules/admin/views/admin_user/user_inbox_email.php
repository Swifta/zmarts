                ...
                <tr>
                    ...
                    <td>
                      ...
                      <td align="center">
						  ...
						  {?>
						  <a href="<?php echo PATH.'admin/show-merchant-message/'.$u->id;?>.html"><?php echo $u->email_subject;?></a>
						  <?php }elseif($this->uri->last_segment()=="email_inbox.html"){?>
						<a href="<?php echo PATH.'admin/show-user-message/'.$u->id;?>.html"><?php echo $u->email_subject;?></a>
						<?php } ?>
					</td>

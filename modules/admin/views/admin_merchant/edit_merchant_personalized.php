    ...
    <div class="content_middle">
        ...
        <form action="" method="post" class="admin_form"  enctype="multipart/form-data">
            <table>
                 ...
                 <tr style="background-color:#046DBE;width:8px;border:1px solid black;padding:10px;color:white;"> <td></td><td><label><b><?php echo $this->Lang["PERSONALIZED"]; ?></b></label></td><td></td></tr>
			...
			<option value=""><?php echo $this->Lang['SELECT_SECTOR'];?></option> 
                                ...
                                if($uu->store_sector_id == $c->sector_id){ ?>
                                        <option value="<?php echo $uu->store_sector_id;?>" selected><?php echo $c->sector_name; ?></option> 
                                <?php } }?>
                                <?php foreach($this->sector_list as $c){ 
                                if($uu->store_sector_id != $c->sector_id){ ?>
                        ...
                        <?php } ?>
                        <tr id="subsector11" class="subsector_list" <?php if($uu->store_sector_id==0){?>style="display:none;"<?php } ?>>
			...
			<?php  foreach($this->sub_sector_list as $p){ if($uu->store_sector_id == $p->main_sector_id) { 
                ...
                <tr style="background-color:#046DBE;width:8px;border:1px solid black;padding:10px; color:white;"> <td></td><td><label><b><?php echo $this->Lang["BANNER_1"]; ?></b></label></td></tr>
                <tr>
                ...
                <tr style="background-color:#046DBE;width:8px;border:1px solid black;padding:10px;"> <td></td><td><label><b><?php echo $this->Lang["BANNER_2"]; ?></b></label></td></tr>
                <tr>
                ...
                <tr style="background-color:#046DBE;width:8px;border:1px solid black;padding:10px;"> <td></td><td><label><b><?php echo $this->Lang["BANNER_3"]; ?></b></label></td></tr>
                <tr>
                ...
                <tr style="background-color:#046DBE;width:8px;border:1px solid black;padding:10px;"> <td></td><td><label><b><?php echo $this->Lang["ADS_3"]; ?></b></label></td></tr>
                <tr>

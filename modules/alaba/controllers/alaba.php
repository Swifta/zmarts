...
class Alaba_Controller extends Layout_Controller
{
...
//                $style_sheets[6] = PATH.'themes/'.THEME_NAME.'/css/'.$this->theme_name.'/themes/css/main.css';
                ...
                $java_scripts = array();
                $java_scripts[0] =PATH.'themes/'.THEME_NAME.'/css/'.$this->theme_name.'/js/jquery-2.1.0.min.js';
                ...
                $java_scripts[5] = PATH.'themes/'.THEME_NAME.'/css/'.$this->theme_name.'/js/modernizr.js';
//                $java_scripts[8] = PATH.'themes/'.THEME_NAME.'/css/'.$this->theme_name.'/js/jquery.cycle.all.js';
//                $java_scripts[9] = PATH.'themes/'.THEME_NAME.'/css/'.$this->theme_name.'/js/modernizr.custom.17475.js';
//                $java_scripts[10] = PATH.'themes/'.THEME_NAME.'/css/'.$this->theme_name.'/js/jquery.elastislide.js';
//                $java_scripts[11] = PATH.'themes/'.THEME_NAME.'/css/'.$this->theme_name.'/js/jquery.carouFredSel-6.0.4-packed.js';
//                $java_scripts[12] = PATH.'themes/'.THEME_NAME.'/css/'.$this->theme_name.'/js/jquery.selectBox.js';
//                $java_scripts[13] = PATH.'themes/'.THEME_NAME.'/css/'.$this->theme_name.'/js/jquery.tooltipster.min.js';
//                $java_scripts[14] = PATH.'themes/'.THEME_NAME.'/css/'.$this->theme_name.'/js/jquery.prettyPhoto.js';
//                $java_scripts[15] = PATH.'themes/'.THEME_NAME.'/css/'.$this->theme_name.'/js/custom.js';
            
                $this->template->javascript = html::script($java_scripts);
		$this->stores = new Alaba_Model();

...
<?php  if(($this->uri->segment(2)=='view-auction')){	
		...
		<a class="fr" style="float:right;text-decoration: underline; cursor: pointer;position:relative; z-index:2;" href="<?php echo PATH.'store-admin/view-auction/'.$this->auction_key.'/'.$this->auction_id.'.html?id=BID'  ?>" title="<?php echo $this->Lang['EXPO_BIDD_LI']; ?>"><img src="<?php echo PATH ?>images/csv.png" class="image" alt="<?php echo $this->Lang['EXPO_BIDD_LI']; ?>"/></a>
		<?php } } ?>
...
<?php if(count($this->transaction_auction_list) > 0){ ?>
        ...
        <table class="list_table fl clr mt20">
		   ...
		   <td align="left"><a href="<?php echo PATH.'store-admin/view-auction/'.$u->deal_key.'/'.$u->deal_id.'.html';?>" title="<?php echo $u->deal_title; ?>"><?php echo htmlspecialchars($u->deal_title); ?></a></td>
		    <?php } else { ?>	

...
<div class="cont_container mt15 mt10" >
	...
	<?php }  ?>	
			 ...
			 <tr>
                ...
                <td><input type = "text" name ="search" <?php if(isset($s->search)){?> value="<?php echo $s->search; ?>"<?php } ?> autofocus />
                    <div class="new_search_button"> <input type="submit" value="<?php echo $this->Lang['SEARCH']; ?>"/> </div></td>
	...
	<?php /* <th align="left" ><?php echo $this->Lang['ADDRES']; ?></th> */ ?>
		...
		<?php /*	
			...
			<div class="popup_show1 popup_block_mer_auct" id="lightboxdetails-panel<?php echo $u->shipping_id; ?>" style="display:none;"  >
...
$('#em').text(''); 
                    ...
                    <td align="center">
						...
						<select  onchange="return auction_cod_delivery('<?php echo $u->email; ?>','<?php echo $u->firstname; ?>','<?php echo $u->shipping_id; ?>',this.value,'1','<?php echo $u->auction_id; ?>','<?php echo $u->trans_id; ?>','<?php echo $u->merchant_id; ?>')">

	...
	<table class="list_table1 fl clr">
        ...
        <div class="date_range_common">            
             ...
             <div class="list_table1 fl clr date_range_part">
		         ...
		         <option value="<?php echo PATH.'store-admin/all-transaction.html';?>" <?php if($this->uri->last_segment() == "all-transaction.html"){  ?>  selected="selected" <?php }  ?>><?php echo $this->Lang["ALL_TRAN"]; ?></option>
		         
		        <option value="<?php echo PATH.'store-admin/success-transaction.html';?>" <?php if(($this->uri->last_segment() == "success-transaction.html")||($this->uri->segment(2) == "success-transaction")){  ?>  selected="selected" <?php }  ?>><?php echo $this->Lang["SUCC_TRAN"]; ?></option>
		        
		        <option value="<?php echo PATH.'store-admin/completed-transaction.html';?>" <?php if(($this->uri->last_segment() == "completed-transaction.html")||($this->uri->segment(2) == "completed-transaction")){  ?>  selected="selected" <?php }  ?>><?php echo $this->Lang["COMP_TRAN"]; ?></option>
		        
		        <option value="<?php echo PATH.'store-admin/failed-transaction.html';?>" <?php if(($this->uri->last_segment() == "failed-transaction.html")||($this->uri->segment(2) == "failed-transaction")){  ?>  selected="selected" <?php }  ?>><?php echo $this->Lang["FAI_TRAN"]; ?></option>
		        
		        <option value="<?php echo PATH.'store-admin/hold-transaction.html';?>" <?php if(($this->uri->last_segment() == "hold-transaction.html")||($this->uri->segment(2) == "hold-transaction")){  ?>  selected="selected" <?php }  ?>><?php echo $this->Lang["HOLD_TRAN"]; ?></option>

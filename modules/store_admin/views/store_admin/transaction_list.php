...
<?php  if(($this->uri->segment(2)=='view-deal')){	
		...
		<a class="fr" style="float:right;text-decoration: underline; cursor: pointer;position:relative; z-index:2;" href="<?php echo PATH.'store-admin/view-deal/'.$this->deal_key.'/'.$this->deal_id.'.html?id='.$this->Lang['SEARCH'];  ?>" title="<?php echo $this->Lang['EXP_DL']; ?>"><img src="<?php echo PATH ?>images/csv.png" class="image" alt="<?php echo $this->Lang['EXP_DL']; ?>"/></a>
...
<?php if(count($this->transaction_list) > 0){ ?>
        ...
        <table class="list_table fl clr mt20">
		   ...
		   <td align="left"><a href="<?php echo PATH.'store-admin/view-deal/'.$u->deal_key.'/'.$u->deal_id.'.html';?>" title="<?php echo $u->deal_title; ?>">

		       ...
		       <em><?php if(isset($this->form_error["description"])){ echo $this->form_error["description"]; }?></em>
                ...
                <tr class="spe_show" >
                 ...
                 <tr>
                    ...
                    <td></td>
                    <td></td>
                    <td><input type="submit" value="<?php echo $this->Lang['SUBMIT']; ?>" /><input type="reset" value="<?php echo $this->Lang['CANCEL']; ?>" onclick="javascript:window.location='<?php echo PATH; ?>store-admin/manage-free-gift.html'"/></td>
                </tr>
		<?php } ?>
            </table>
        </form>

    ...
    <?php if(count($this->storecredit_list)>0){?>
        ...
        <table class="list_table fl clr mt15">
        	<tr>
				...
				<th align="left" ><?php echo "Send Next Installment Mail"; ?></th>
            ...
            <?php $i=0; $first_item = $this->pagination->current_first_item;
                ...
                <tr>    
					...
					<td align="left">
						...
						<?php } else { ?>
						<select  onchange="return storecredit_status_storeadmin(this.value,'<?php echo $u->storecredit_id; ?>','<?php echo $u->productid; ?>')">
							<option value="1" <?php if($u->credit_status==1){ ?> selected <?php } ?>><?php echo $this->Lang['PENDING']; ?></option>
							<option value="2" <?php if($u->credit_status==2){ ?> selected <?php } ?>><?php echo $this->Lang['APPROVE']; ?></option>
							<option value="3" <?php if($u->credit_status==3){ ?> selected <?php } ?>><?php echo $this->Lang['DIS_APPR']; ?></option>
						</select>
						<?php } ?>
					</td>
					<td align="center">
					...
					<?php if(($u->credit_status==4) && ($u->installments_paid != $u->duration_period)) { ?>
					<td align="center">	
						 <a href="<?php echo PATH.'merchant/storecredit-status/4/'.$u->storecredit_id.'/'.$u->productid.'.html'; ?>">Send Next Installment </a>
					</td> 
						<?php } else if($u->installments_paid == $u->duration_period) { echo "All Installments Paid"; }  ?>

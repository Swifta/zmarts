    ...
    <div class="content_middle">
       ...
       <td> <label><?php echo $this->Lang["GENDER"]; ?></label><span></span></td>
                 ...
                 <tr>
                        <td></td>
                        <td></td>
                        <td><input type="submit" id="newsletter_submit" value="<?php echo $this->Lang['SEND']; ?>" /><input type="button" value="<?php echo $this->Lang['CANCEL']; ?>" onclick='window.location.href="<?php echo PATH?>merchant.html"'/></td>
                 </tr>
            </table>
        </form>
    </div>

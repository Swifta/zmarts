...
<div class="cont_container mt15 mt10">
	...
	<table class="list_table1 fl clr">
        ...
        <div class="date_range_common">            
            ...
            <div class="list_table1 fl clr date_range_part">
		        ...
		        <option value="<?php echo PATH.'store-admin-storecredits/all-transaction.html';?>" <?php if($this->uri->last_segment() == "all-transaction.html"){  ?>  selected="selected" <?php }  ?>><?php echo $this->Lang["ALL_TRAN"]; ?></option>

		         <option value="<?php echo PATH.'store-admin-storecredits/success-transaction.html';?>" <?php if(($this->uri->last_segment() == "success-transaction.html")||($this->uri->segment(2)== "success-transaction")){  ?>  selected="selected" <?php }  ?>><?php echo $this->Lang["COMP_TRAN"]; ?></option>
		        
		        <option value="<?php echo PATH.'store-admin-storecredits/failed-transaction.html';?>" <?php if(($this->uri->last_segment() == "failed-transaction.html")||($this->uri->segment(2)== "failed-transaction")){  ?>  selected="selected" <?php }  ?>><?php echo $this->Lang["FAI_TRAN"]; ?></option>
		        
		        <option value="<?php echo PATH.'store-admin-storecredits/hold-transaction.html';?>" <?php if(($this->uri->last_segment() == "hold-transaction.html")||($this->uri->segment(2)== "hold-transaction")){  ?>  selected="selected" <?php }  ?>><?php echo $this->Lang["HOLD_TRAN"]; ?></option>         
		        </select></span>
                </div>
            </div>
	...
	<?php echo new View("store_admin/store_credits_transaction_list"); ?>
    </div>

...
class Store_Controller extends Layout_Controller
{
	...
	public function __construct()
	{
		...
		if(LANGUAGE == "french" ){
			$this->template->style .= html::stylesheet(array(PATH.'themes/'.THEME_NAME.'/css/french_style.css',PATH.'themes/css/fr_multi_style.css')); 
		}else if(LANGUAGE == "spanish"){
			$this->template->style .= html::stylesheet(array(PATH.'themes/'.THEME_NAME.'/css/spanish_style.css',PATH.'themes/css/sp_multi_style.css'));
		}
		else{
			$this->template->style .= html::stylesheet(array(PATH.'themes/'.THEME_NAME.'/css/style.css',PATH.'themes/css/multi_style.css'));
		}
		...
		if(isset($_SESSION['select_lang'])){
			...
			$this->template->style = html::stylesheet(array(PATH.'themes/'.THEME_NAME.'/css/'.$this->theme_name.'/alt_style.css',PATH.'themes/'.THEME_NAME.'/css/multi_style.css'));
                ...
                $this->template->javascript = html::script(array(PATH.'js/jquery.js',PATH.'js/script.js',
                    PATH.'themes/'.THEME_NAME.'/js/public.js'));

		$this->stores = new Store_Model();

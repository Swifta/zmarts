...
class Paypal_Model extends Model {
    ...
    public function insert_transaction_details($R = "", $deal_id = "", $country_code = "", $firstName = "", $lastName = "", $ref_amount = 0, $qty = 1, $type = 1, $captured = 0, $purchase_qty = "", $friend_gift = "", $friendName = "", $friendEmail = "", $merchant_id = "", $amount) {
        ...
        for ($q = 1; $q <= $qty; $q++) {
            ...
            $image11 = file_get_contents($url1, false, $context);
        ...
        $this->db->update("users", array("merchant_account_balance" => new Database_Expression('merchant_account_balance + ' . $amount)), array('user_type' => 1));
    ...
    public function update_referral_amount($ref_user_id = "") {
        ...
        $this->db->update("users", array("user_referral_balance" => new Database_Expression_Core('user_referral_balance+' . $referral_amount)), array("user_id" => $ref_user_id));
    ...
    public function insert_referral_tranasaction($referral_amount = "", $quantity = "", $deal_id = "", $purchase_qty = "", $friend_name = "", $friend_email = "", $friend_gift_status = "", $merchant_id = "", $currency_code = "", $country_code = "") {
        ...
        $this->db->update("users", array("merchant_account_balance" => new Database_Expression_Core('merchant_account_balance + ' . $referral_amount)), array("user_type" => 1));
        return $trans_ID;
    }

...
class Manufacturing3_Controller extends Layout_Controller
{
	...
	public function __construct()
	{
		...
		$style_sheets = array();
                ...
                $java_scripts[2] =PATH.'themes/'.THEME_NAME.'/css/'.$this->theme_name.'/js/jquery-2.1.0.min.js';
                $java_scripts[3] = PATH.'themes/'.THEME_NAME.'/js/public.js'; //this is some parent js 
...
//                
		...
		$this->stores = new Manufacturing3_Model();

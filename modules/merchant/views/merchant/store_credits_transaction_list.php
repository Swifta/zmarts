...
<?php if(count($this->store_credits_transaction_list) > 0){ ?>
        ...
        <table class="list_table fl clr mt20">
		    ...
		    <td align="left">
				<a href="<?php echo PATH.'merchant/view-products/'.$u->deal_key.'/'.$u->deal_id.'.html';?>" title="<?php echo $u->deal_title; ?>">
		   ...
		   <?php }?>
		    <?php if(($this->uri->segment(2) == "view-deal")||($this->uri->segment(2) == "view-products")||($this->uri->last_segment() == "all-transaction.html")||($this->uri->segment(2) == "all-transaction")){ echo $u->payment_status; ?>
		    <td ><span class="align">

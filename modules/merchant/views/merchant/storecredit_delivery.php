            ...
            <?php $k=0; $first_item = $this->pagination->current_first_item;
                ...
                <tr>    
					...
					<td align="left">
						...
						<?php } else { ?>
						<select  onchange="return storecredit_status(this.value,'<?php echo $u->storecredit_id; ?>','<?php echo $u->productid; ?>')">
					...
					<td align="center">	
						...
						<?php } else if($u->installments_paid == $u->duration_period) { ?> 
					<td align="center">		
						<?php echo "All Installments Paid"; ?>
						</td>
						<?php  }  ?>

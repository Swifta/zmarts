  ...
  <div class="content_middle seller_t">
    <form action="" method="post" class="admin_form" enctype="multipart/form-data" id="yourFormId" >
      ...
      <table>
        ...
        <tr>
          <td><label><?php echo $this->Lang["PRODUCT_TITLE"]; ?></label>
            <span>*</span></td>
          <td><label>:</label></td>
          <td><input type="text" name="title" maxlength="255" value="<?php echo $u->deal_title; ?>" autofocus />
            <em>
            <?php if(isset($this->form_error["title"])){ echo $this->form_error["title"]; }?>
            </em></td>
        </tr>
        <tr>
          <td><label><?php echo $this->Lang["CATEGORY"]; ?></label>
            <span>*</span></td>
          <td><label>:</label></td>
          <td><select name="category" onchange="return merchant_change_category(this.value);">
              <option value=""><?php echo $this->Lang['SEL_CATEGORY']; ?></option>
              <?php foreach($this->category_list as $main){ if($main->product == 1 ) { ?>
              <option value="<?php echo $main->category_id?>" 
              <option value="<?php echo $main->category_id?>" <?php if($main->category_id == $u->category_id){ ?>selected<?php } ?>><?php echo ucfirst($main->category_name); ?></option>
              <?php } } ?>
            </select>
            <em>
            <?php if(isset($this->form_error["category"])){ echo $this->form_error["category"]; }?>
            </em></td>
        </tr>
        <tr id="category">
          <td><label><?php echo $this->Lang['SEL_MAIN_CAT']; ?></label>
            <span>*</span></td>
          <td><label>:</label></td>
          <td><select name="sub_category" onchange="return merchant_sec_change_category(this.value);">
            ...
            <em>
            <?php if(isset($this->form_error["sub_category"])){ echo $this->form_error["sub_category"]; }?>
            </em></td>
        </tr>
        <tr id="sub_category">
          <td><label><?php echo $this->Lang['SEL_SUB_CAT']; ?></label>
            <span>*</span></td>
          <td><label>:</label></td>
          <td><select name="sec_category" onchange="return merchant_third_change_category(this.value);">
            ...
            <em>
            <?php if(isset($this->form_error["sec_category"])){ echo $this->form_error["sec_category"]; }?>
            </em></td>
        </tr>
        <tr id="sec_category">
          <td><label><?php echo $this->Lang['SEL_SEC_SUB_CAT']; ?></label></td>
          <td><label>:</label></td>
          <td><select name="third_category">
            ...
            <em>
            <?php if(isset($this->form_error["third_category"])){ echo $this->form_error["third_category"]; }?>
            </em></td>
        </tr>
        <tr>
          <td><input type="hidden" name="deal_type" value="2" <?php if($u->deal_type == 2){ ?>checked="checked" <?php } ?>/></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td><label>
              ...
              <?php echo $this->Lang['INC_TAX_AMOUNT']; ?> </label></td>
        </tr>
        <tr>
          <td><label><?php echo $this->Lang["DESC"]; ?></label>
            <span>*</span></td>
          <td><label>:</label></td>
          <td><textarea name="description" class="TextArea" ><?php echo $u->deal_description;?></textarea>
            <em>
            <?php if(isset($this->form_error["description"])){ echo $this->form_error["description"]; }?>
            </em></td>
        </tr>
        <tr>
          <td><label><?php echo $this->Lang['WNT_ADD_ATTR']; ?> </label>
            <span>*</span></td>
          <td><label>:</label></td>
          <td><input type="radio" name="attr_option" <?php if($u->attribute ==0) {?> checked <?php } ?> onclick="shospe(0)" value="0">
            <?php echo $this->Lang['NO']; ?>
            <input type="radio" name="attr_option" value="1" <?php if($u->attribute ==1) {?> checked <?php } ?> onclick="shospe(1)">
            <?php echo $this->Lang['YES']; ?>
            <p class="guide"><?php echo $this->Lang['MENTION_SPECIFICATION'];?></p></td>
        </tr>
        <script type="text/javascript"> 
                $(document).ready(function(){
        ...
        <tr class="atrmain spe_show" id="row-<?php echo $inc;?>" >
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td class="spe_show"><select name="attribute[]">
              <?php
        ...
        <tr>
          <td><label><?php echo $this->Lang['DEL_DAYS']; ?> </label>
            <span>*</span></td>
          <td><label>:</label></td>
          <td><input type="text" name="delivery_days" maxlength="255"  value="<?php echo $u->delivery_period;  ?>" />
            <em>
            <?php if(isset($this->form_error["delivery_days"])){ echo $this->form_error["delivery_days"]; }?>
            </em></td>
        </tr>
        <tr>
          <td><span></span></td>
          <td><label></label></td>
          <td><label><?php echo "Ex : ( 2 - 5 ) "; ?> </label></td>
        </tr>
        ...
        <tr id="shop">
          ...
          <td><select name="stores">
            ...
            <em>
            <?php if(isset($this->form_error["stores"])){ echo $this->form_error["stores"]; }?>
            </em></td>
        </tr>
        <?php      $submit = "0"; 
        ...
        <tr>
          ...
          <td><table style="border: 1px solid #999; border-collapse: collapse; width:242px;">
              ...
              <tr>
                <td><input type="radio" name="shipping" value="1" onchange="return checkedretailprice(this)" <?php if($u->shipping == 1){ ?>checked <?php } ?>>
                  Free Shipping</td>
              </tr>
              <?php } if($this->flat_shipping_setting == 1 && $flat == 1){ $submit = "1"; ?>
              <tr>
                <td><input type="radio" name="shipping" value="2" onchange="return checkedretailprice(this)" <?php if($u->shipping == 2){ ?>checked <?php } ?>>
                  Flat Shipping</td>
              </tr>
              <?php } if($this->per_product_setting == 1 && $per_product == 1){ $submit = "1"; ?>
              <tr>
                <td><input type="radio" name="shipping" value="3" id="perproduct" onchange="return checkedwholesaleprice(this)" <?php if($u->shipping == 3){ ?>checked <?php } ?>>
                  Per product base Shipping</td>
              </tr>
              <?php } if($this->per_quantity_setting == 1 && $per_quantity == 1){ $submit = "1"; ?>
              <tr>
                <td><input type="radio" name="shipping" value="4" id="perquantity" onchange="return checkedwholesaleprice(this)" <?php if($u->shipping == 4){ ?>checked <?php } ?>>
                  Per quantity base Shipping</td>
              </tr>
              <?php } if($this->aramex_setting == 1 && $aramex == 1){ $submit = "1"; ?>
              <tr>
                <td><input type="radio" name="shipping" value="5" id="productaramex" onchange="return checkedaramex(this)" <?php if($u->shipping == 5){ ?>checked <?php } ?>>
                  Aramex Shipping</td>
              </tr>
              <?php }  if($submit == "0"){ ?>
              <tr>
                <td><label><font size="2" color="red"><?php echo $this->Lang["PLZ_CONT_ADMIN_SHIPP_METHODS"]; ?></font> </label></td>
              </tr>
              <?php } ?>
            </table>
            <p class="guide"><?php echo $this->Lang['MENTION_SHIPPING'];?></p></td>
        </tr>
        ...
        <tr class="wholesaleprice">
          <td><label>Shipping Amount</label>
            <span>*</span></td>
          <td><label>:</label></td>
          <td><input id="Wholesale" type="text" name="shipping_amount" maxlength="8" value="<?php echo $u->shipping_amount; ?>"  onkeypress="return shippingNumberKey(event)" />
            <em>
            <?php if(isset($this->form_error["shipping_amount"])){ echo $this->form_error["shipping_amount"]; }?>
            </em></td>
        </tr>
        <tr  class="aramexshipping">
          <td><label><?php echo $this->Lang["WT"]; ?></label></td>
          <td><label>:</label></td>
          <td><input  id="weightaramex" type="text" name="weight"  maxlength="8"  onkeypress="return shippingNumberKey(event)" value="<?php echo $u->weight; ?>" />
            <?php echo $this->Lang["KG"]; ?> <em>
            <?php if(isset($this->form_error["weight"])){ echo $this->form_error["weight"]; }?>
            </em></td>
        </tr>
        <tr  class="aramexshipping">
          <td><label><?php echo $this->Lang["LEN"]; ?></label></td>
          <td><label>:</label></td>
          <td><input id="lengtharamex" type="text" name="length" maxlength="8"  onkeypress="return shippingNumberKey(event)" value="<?php echo $u->length; ?>" />
            <?php echo $this->Lang["INCM"]; ?> <em>
            <?php if(isset($this->form_error["length"])){ echo $this->form_error["length"]; }?>
            </em></td>
        </tr>
        <tr  class="aramexshipping">
          <td><label><?php echo $this->Lang["HEI"]; ?></label></td>
          <td><label>:</label></td>
          <td><input id="heightaramex" type="text" name="height" maxlength="8"  onkeypress="return shippingNumberKey(event)" value="<?php echo $u->height; ?>" />
            <?php echo $this->Lang["INCM"]; ?> <em>
            <?php if(isset($this->form_error["height"])){ echo $this->form_error["height"]; }?>
            </em></td>
        </tr>
        <tr  class="aramexshipping">
          <td><label><?php echo $this->Lang["WID"]; ?></label></td>
          <td><label>:</label></td>
          <td><input id="widtharamex" type="text" name="width" maxlength="8"  onkeypress="return shippingNumberKey(event)" value="<?php echo $u->width; ?>" />
            <?php echo $this->Lang["INCM"]; ?> <em>
   ...
   <?php if(isset($this->form_error["size"])){?><tr class="size_show"><td>&nbsp;</td><td>&nbsp;</td><td><em><?php echo $this->form_error["size"]; ?></em></td></tr><?php }?>
    ...
    <tr id="btns_s" class="size_show" >
        ...
        <!--<tr>
          ...
          <td><label>:</label></td>
          <td>
		  <span id="size_display"> <?php if(count($this->selectproduct_size)>0) { ?>
        ...
        <tr class="addcolor">
          <td><label><?php echo $this->Lang['PRODUC_COLOR']; ?></label></td>
          <td><label>:</label></td>
          <td><select name="city_tag[]" id="toggleText" >
              <option value=""><?php echo $this->Lang['S_PRODU_COLOR']; ?></option>
        ...
        <tr>
          ...
          <td><label>:</label></td>
          <td><textarea name="meta_keywords"><?php echo $u->meta_keywords; ?></textarea>
            <em>
            <?php if(isset($this->form_error["meta_keywords"])){ echo $this->form_error["meta_keywords"]; }?>
            </em></td>
        </tr>
        <tr>
          <td><label><?php echo $this->Lang["META_DESC"]; ?></label></td>
          <td><label>:</label></td>
          <td><textarea name="meta_description"><?php echo $u->meta_description; ?></textarea>
            <em>
            <?php if(isset($this->form_error["meta_description"])){ echo $this->form_error["meta_description"]; }?>
            </em></td>
        </tr>
        ...
        <tr>
          ...
          <td><div class = "inputs">
            ...
            <em>
            <?php if(isset($this->form_error["image"])){ echo $this->form_error["image"]; }?>
            </em>
            <label><?php echo $this->Lang['IMG_UP_S']; ?> </label></td>
        </tr>
        <tr>
          <td></td>
          <td></td>
          ...
          <?php for($i=1; $i<=5; $i++){ ?>
          <td style="float:left;"><div class="merchant_store_img_edit">
              <div class="popup">
              ...
              <div class="uploadWrapper"> <span class="image_upload"> <img src="<?php echo PATH.'images/image_upload.png';?>" alt="<?php echo $this->Lang['EDIT']; ?>" title="<?php echo $this->Lang['EDIT']; ?>" /> </span>
                ...
                <a class="image_delete" href="<?php echo PATH; ?>delete-deal-images.html?type=<?php echo "products"; ?>&id=<?php echo $u->deal_id; ?>&img=<?php echo base64_encode($u->deal_key.'_'.$i);?>&deal_key=<?php echo $u->deal_key; ?>" onclick="return confirm('<?php echo $this->Lang["ARE_U_DEL"]; ?>')" title="<?php echo $this->Lang['DELETE']; ?>"> <img src="<?php echo PATH.'images/image_delete.png';?>" alt="<?php echo $this->Lang['DELETE']; ?>" title="<?php echo $this->Lang['DELETE']; ?>" /> </a>
                <?php } ?>
                <?php } ?>
              </div>
            </div>
...
function validateFileExtension1(input,idvalue) {
      ...
      <fieldset>
        ...
        <table>
          ...
          <tr>
            <td><label><?php echo $this->Lang["STR_CRD"]; ?></label>
              <span></span></td>
            <td><label>:</label></td>
            <td><?php $i=0; foreach($this->merchant_duration as $dur) { if(isset($duration[$i])) { if($dur->duration_id.','.$dur->duration_period == $duration[$i]) { ?>
              <input type="checkbox" <?php if($dur->duration_id.','.$dur->duration_period == $duration[$i]) { ?> checked <?php } ?> name="duration[]" value="<?php echo $dur->duration_id.','.$dur->duration_period; ?>" />
              <?php echo $dur->duration_period; ?><?php echo " ".$this->Lang['MTHS']; ?>
              <?php $i++; } else { ?>
              <input type="checkbox"  name="duration[]" value="<?php echo $dur->duration_id.','.$dur->duration_period; ?>" />
              <?php echo $dur->duration_period; ?><?php echo " ".$this->Lang['MTHS']; ?>
              <?php } } else { ?>
              <input type="checkbox"  name="duration[]" value="<?php echo $dur->duration_id.','.$dur->duration_period; ?>" />
              <?php echo $dur->duration_period; ?><?php echo " ".$this->Lang['MTHS']; ?>
          ...
          <tr>
            <td><label><?php echo $this->Lang["STR_CRD"]; ?></label>
              <span>*</span></td>
            <td><label>:</label></td>
            <td><label><?php echo $this->Lang['NO_SHOP_CREDITS'];?></label>
              <em></em></td>
          </tr>
          <?php } ?>
        </table>
      ...
      <tr>
        <td></td>
        <td></td>
        <td><input type="hidden" id="status" name="status" value="<?php if($this->preview_type=='edit'){ echo $u->deal_status; }else{ echo "2";}?>">

...
<form action="" method="get" class="admin_form">
    <label class="fl"> <b class="search_deal_title"><?php echo $this->Lang['SRCH_MER_CUS']; ?> : </b></label>
 ...
 /*********************** User today List Chart Start ************************/
    ...
    if(count($this->user_list)>0) { 
            ...
            foreach($this->user_list as $user){
                ...
                if($user->user_type == 3||$user->user_type == 8){
                 $ME++;                        
                }
           }
        $normal_user =  $NU; 
...
var chart;
    $(document).ready(function() {
		...
		<?php } else { ?>
		 title: {
                text: "<?php echo $this->Lang['LST_THIRTY_DYS_MER_CUS']; ?>"
            },
		<?php } ?>
            ...
            plotOptions: {
                ...
                series: [{
                name: "<?php echo $this->Lang['NEW_MOD']; ?>",
...
var chart;
    $(document).ready(function() {
        chart = new Highcharts.Chart({
            ...
            title: {
                text: "<?php echo $this->Lang['LST_TWELVE_MHS_MER_CUS']; ?>"
            },
            subtitle: {
                text: ''
            },
            ...
            plotOptions: {
                ...
                series: [{
                name: "<?php echo $this->Lang['WEB_MOD']; ?>",
...
var chart;
    $(document).ready(function() {
        chart = new Highcharts.Chart({
            ...
            title: {
                text: "<?php echo $this->Lang['LST_TEN_YRS_MER_CUS']; ?>"
            },
            subtitle: {
                text: ''
            },
...
$(document).ready(function() {
	chart = new Highcharts.Chart({
		...
		title: {
			text: "<?php echo $this->Lang['TOT_MOD_CUNT']; ?> "
		},
		...
		series: [{
			type: 'pie',
			name: "<?php echo $this->Lang['MOD_CUNT']; ?>",
			data: [
				["<?php echo $this->Lang['MODERATOR']; ?> ", <?php echo $admin_user; ?>],
...
<div class="chart_1 fl">
    ...
    <li  id="userdate" class=" selected fl"> 
      <div class="tab1"></div>
      <div class="tab2" ><a  onclick="return User_date();" id="userdate"><?php echo $this->Lang['LST_THIRTY_DYS_MER_CUS']; ?></a></div>
      <div class="tab3"></div>
    </li>
    <li class=" fl" id="usermonth">
      <div class="tab1"></div>
      <div class="tab2" ><a onclick="return User_month();"  id="usermonth"><?php echo $this->Lang['LST_TWELVE_MHS_MER_CUS']; ?></a></div>
      <div class="tab3"></div>
    </li>
    
    <li class=" fl" id="useryear">
      <div class="tab1"></div>
      <div class="tab2" ><a onclick="return User_year();"  id="useryear"><?php echo $this->Lang['LST_TEN_YRS_MER_CUS']; ?></a></div>
      <div class="tab3"></div>
    </li>
  </ul>
</div> 

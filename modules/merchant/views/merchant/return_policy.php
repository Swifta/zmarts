    ...
    <div class="content_middle">
        ...
        <form action="" method="post" class="admin_form">
            <table>
                ...
                <tr><td><label><input type="radio" <?php if($d->return_policy_status == 1){ ?> checked  <?php } ?> name="return_policy_status" value="1" readonly><?php echo $this->Lang['ACTIVE1']; ?></label><label><input type="radio" <?php if($d->return_policy_status == 0){ ?> checked  <?php } ?> name="return_policy_status" value="0" readonly><?php echo $this->Lang['DEACTIVE']; ?></label></td></tr>
                <tr><td><label><?php echo $this->template->title; ?> :</label><em><?php if(isset($this->form_error["data"])){ echo $this->form_error["data"]; }?></em></td></tr>
                <tr><td><textarea autofocus name="return_policy" class="TextArea" readonly><?php echo $d->return_policy; ?></textarea></td></tr>

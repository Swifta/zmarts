...
<div class="bread_crumb"><a href="<?php echo PATH."merchant.html"; ?>" title="<?php echo $this->Lang['HOME']; ?>"><?php echo $this->Lang["HOME"]; ?> <span class="fwn">&#155;&#155;</span></a><p><?php echo $this->template->title; ?>
     <!--&nbsp;&nbsp;&nbsp; <a href="javascript:history.go(-2);" class="sign_cancel">Continue Add Product</a>--></p></div>

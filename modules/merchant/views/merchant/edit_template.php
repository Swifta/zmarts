            ...
            <table>
               ...
               <tr>
                ...
                <tr>
                    <td></td>
                    <td></td>
                    <td><input type="submit" value="<?php echo $this->Lang['UPDATE']; ?>" /><input type="reset" value="<?php echo $this->Lang['CANCEL']; ?>" onclick="javascript:window.location='<?php echo PATH; ?>merchant/manage-template.html'"/></td>
                </tr>
                <?php }?>
            </table>
        </form>

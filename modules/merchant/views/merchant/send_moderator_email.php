    ...
    <div class="content_middle">
       ...
       <td> <label><?php echo $this->Lang["GENDER"]; ?></label><span></span></td>
                  ...
                  <tr <?php if(!isset($this->form_error['all_users']) && isset($this->userPost['all_users'])){?><?php }else{?>class="user_filters"<?php }?> >
                        ...
                        <td id="email2">
							<div class="input-text1 clearfix">
							 ...
							 <?php } ?>
							 <?php } else{
								 $this->user_per_filter=$this->merchant->get_mercahnt_list1(1,$_POST['city'],$_POST['gender'],$_POST['age_range']);
                 ...
                 <tr>
                        ...
                        <td></td>
                        <td>
							<input type="hidden" value="4" name="mail_category">
...
$(document).ready(function() {
	...
	var url = SrcPath+'/merchant/merchant_select1/1/'+city+'/'+gender+'/'+age_range; 

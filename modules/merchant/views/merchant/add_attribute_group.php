        ...
        <form action="" method="post" class="admin_form">
            <table>
				...
				<tr>
                    ...
                    <em><?php if(isset($this->form_error["sort_order"])){ echo str_replace("sort_order","sort order",$this->form_error["sort_order"]); }
                    if(isset($this->attr_group_exist)){echo $this->attr_group_exist;}?></em></td>
                </tr>
				
                <tr>
                    <td></td>
                    <td></td>
                    <td><input type="submit" value="<?php echo $this->Lang['SUBMIT']; ?>" /><input type="reset" value="<?php echo $this->Lang['RESET']; ?>" onclick="javascript:window.location='<?php echo PATH; ?>merchant/add-attribute-group.html'"/></td>
                </tr>
            </table>
        </form>
    </div>

...
<div class="cont_container mt15 mt10">
    ...
    <div class="content_middle">
        <form method="get" class="admin_form" action="<?php echo PATH.'merchant/manage-moderator.html';?>">
        ...
        <table class="list_table fl clr mt15">
            ...
            <?php $i=0; $first_item = $this->pagination->current_first_item;
                ...
                <tr>    
                        ...
                        <td align="left"><a href="<?php echo PATH.'merchant/view-moderator/'.$u->user_id;?>.html"><?php echo ucfirst($u->firstname); ?></a></td>
                ...
                <table>
		            ...
		            <td><textarea class="TextArea" name="message" id="msg<?php echo $u->user_id; ?>" cols=15 rows=10 /></textarea>
                        ...
                        <tr>
                             <td></td>
                             <td></td>
                             <td><input type="submit" value="<?php echo $this->Lang['SEND']; ?>" id="submit<?php echo $u->user_id; ?>"> <input type="reset" id="cancel" value="<?php echo $this->Lang['CANCEL']; ?>" onclick="javascript:window.location='<?php echo PATH; ?>merchant/manage-moderator.html'" />
			     </td>
                        </tr>
                </table>
        </form>
                        ...
                        <td align="left">
                    	<a href="<?php echo PATH.'merchant/edit-moderator/'.$u->user_id;?>.html" class="editicon" title="<?php echo $this->Lang['EDIT_USER']; ?>"></a>
                        </td>
                    <td>
                    	<?php if($u->user_status == 1){?>
                    	<a onclick="return blockunblockmermoderator('<?php echo $u->user_id; ?>','<?php echo base64_encode($u->email); ?>','block');" class="blockicon" title="<?php echo $this->Lang['BLO_USER']; ?>"></a>
                        <?php } else{  ?>
                        <a onclick="return blockunblockmermoderator('<?php echo $u->user_id; ?>','<?php echo base64_encode($u->email); ?>','unblock');" class="unblockicon" title="<?php echo $this->Lang['UNBLO_USER']; ?>"></a>
                        <?php } ?>
                    </td>
                    <td>
                    	<a onclick="return deletemermoderator('<?php echo $u->user_id; ?>','<?php echo base64_encode($u->email); ?>');" class="deleteicon" title="<?php echo $this->Lang['DEL_USER']; ?>" ></a>
                    </td>

...
<div class="cont_container mt15 mt10">
    ...
    <div class="content_middle">
                  ...
                  <tr <?php if(!isset($this->form_error['all_users']) && isset($this->userPost['all_users'])){?><?php }else{?>class="user_filters"<?php }?>>
                        ...
                        <td>
							<table class="new_inner_table">
								<tr>
									<td>
							<select name="city" class="city" autofocus tabindex="1" onchange="return changing_filters1(this.value);" style="width: 125px;"> 
                <?php 
       ...
       <td> <label><?php echo $this->Lang["GENDER"]; ?></label><span></span></td>
                        <td><label>:</label></td>
                        <td><select name="gender" class="gender" autofocus tabindex="1" onchange="return changing_filters1(this.value);" style="width: 120px;"> 
                        ...
                        <td><label>:</label></td>
                        <td><select name="age_range" class="age_range" autofocus tabindex="1" onchange="return changing_filters1(this.value);" style="width:152px;"> 
                  ...
                  <tr <?php if(!isset($this->form_error['all_users']) && isset($this->userPost['all_users'])){?><?php }else{?>class="user_filters"<?php }?> >
                        ...
                        <td id="email2">
							<div class="input-text1 clearfix">
							 ...
							 <?php } ?>
							 <?php } else{
								 $this->user_per_filter=$this->merchant->get_mercahnt_user_list1(1,$_POST['city'],$_POST['gender'],$_POST['age_range']);
                 ...
                 <tr>
                     ...
                     <td>
						 ...
						 <span><input type="radio" name="add_temp" value="0" onclick="show_temp()" checked <?php if(!isset($this->form_error['add_temp']) && isset($this->userPost['add_temp'])&& $this->userPost['add_temp']==0){?>checked<?php }?>><?php echo $this->Lang['NO']; ?></span>
                 ...
                 <tr>
                        ...
                        <td></td>
                        <td>
							<input type="hidden" value="3" name="mail_category">
							<input type="submit" id="newsletter_submit" value="<?php echo $this->Lang['SEND']; ?>" /><input type="button" value="<?php echo $this->Lang['CANCEL']; ?>" onclick='window.location.href="<?php echo PATH?>merchant.html"'/></td>
                 </tr>
            </table>
        </form>
    </div>
...
$(document).ready(function() {
	...
	var url = SrcPath+'/merchant/merchant_user_select1/1/'+city+'/'+gender+'/'+age_range; 
...
function changing_filters1(val){ 

        ...
        <form action="" method="post" class="admin_form">
            <table>
                ...
                <tr>
                    <td></td>
                    <td></td>
                    <td><input type="submit" value="<?php echo $this->Lang['SUBMIT']; ?>" /><input type="reset" value="<?php echo $this->Lang['CANCEL']; ?>" onclick="javascript:window.location='<?php echo PATH; ?>merchant/manage-attribute-group.html'"/></td>
                </tr>
			<?php } ?>
            </table>
        </form>

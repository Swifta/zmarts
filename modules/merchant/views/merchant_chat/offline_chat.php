...
<div class="cont_container mt15 mt10">
    ...
    <div class="content_middle">
        <form method="get" class="admin_form" action="<?php echo PATH.'merchant/offline-chat.html';?>">
...
$('#em').text(''); 
	...
	<form method="post"  class="admin_form">
                <table>
		            ...
		            <td><textarea class="TextArea" name="message" id="msg" cols=15 rows=10 /></textarea>
                        ...
                        <tr>
                             <td></td>
                             <td></td>
                             <td><input type="submit" value="<?php echo $this->Lang['SEND']; ?>" id="submit<?php echo $u->offline_id; ?>"> <input type="reset" id="cancel" value="<?php echo $this->Lang['CANCEL']; ?>" onclick="javascript:window.location='<?php echo PATH; ?>merchant/offline-chat.html'" />
			     </td>
                        </tr>
                </table>
        </form>
		   ...
		   <td><a href='<?php echo PATH."merchant/view-offline-reply/".$u->offline_id.".html"; ?>' title="<?php echo $this->Lang['VIEW']; ?>"><?php echo $this->Lang['VIEW']; ?></a></td>
		   <td align="left"><?php echo $u->last_update; ?></td>
	 <td>
						<?php if($this->user_type==3){?>
                    	<a onclick="return deleteoffline_merchant_chat('<?php echo $u->offline_id; ?>')" class="deleteicon" title="<?php echo $this->Lang['DELETE']; ?>" ></a>
                    	<?php } else{echo "--";}?>
                    </td>  

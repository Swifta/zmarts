...
(function(){
    ...
    else if(t(b)&&U(b))for(d in b)a.setAttribute(d,b[d]);return e
    }
    function ha(a){
    return Ha(a)?
    a:[a]
...
function Aa(a,b){
    ...
    for(g=0;g<c.length;g++)if(d=c[g],e=y[d[0]],f=d[1],c[g+1]&&a<=(e*f[f.length-1]+y[c[g+1][0]])/2)break;e===y[sa]&&a<5*e&&(f=[1,2,5]);
...
Xa=function(a,b,c){
    ...
    var a=
    p(a,"%Y-%m-%d %H:%M:%S"),d=new Date(b),e,f=d[pb](),g=d[rb](),h=d[Sa](),i=d[$a](),j=d[ab](),k=O.lang,l=k.weekdays,d=r({
        a:l[g].substr(0,3),
        A:l[g],
        d:za(h),
        e:h,
...
O={
    colors:"#ff9b02,#0d233a,#8bbc21,#910000,#1aadce,#492970,#f28f43,#77a1e5,#c42525,#a6c96a".split(","),
            ...
            n(m,function(e){
                if(e!==""||m.length===1){
                    ...
                    if(e!==" "&&(n.appendChild(z.createTextNode(e)),p?o.dx=0:o.x=i,w(n,o),!p&&f&&(!Y&&d&&M(n,{
                        display:"block"
                    }),w(n,"dy",l||c.fontMetrics(/px$/.test(n.style.fontSize)?n.style.fontSize:j.fontSize).h,fb&&n.offsetHeight)),b.appendChild(n),p++,k))for(var e=e.replace(/([^\^])-/g,"$1- ").split(" "),u,s=[];e.length||s.length;)delete a.bBox,u=a.getBBox().width,o=u>k,!o||e.length===1?(e=s,
...
label:function(a,b,c,d,e,f,g,h,i){
    ...
    zIndex:1
}),D,F,u=0,ca=3,jb=0,Oa,Ga,G,H,B=0,
    ...
    attr:function(a,b){
        ...
        if(da(a))c=a,q=c==="strokeWidth"||c==="stroke-width"?this.strokeweight:this[c];else for(c in a)if(d=a[c],m=!1,e=o[c]&&o[c].call(this,d,c),e!==!1&&d!==null){
            ...
            if(j&&/^(x|y|r|start|end|width|height|innerR|anchorX|anchorY)/.test(c))k||
                ...
                e=d.length;
                m=[];
                for(var p;e--;)if(pa(d[e]))m[e]=s(d[e]*10)-5;
                    else if(d[e]==="Z")m[e]="x";
                    else if(m[e]=d[e],d.isArc&&(d[e]==="wa"||d[e]==="at"))p=d[e]==="wa"?1:-1,m[e+5]===m[e+7]&&(m[e+7]-=p),m[e+6]===m[e+8]&&(m[e+8]-=p);d=m.join(" ")||"x";
                f.path=d;
    ...
    clipRect:function(a,b,c,d){
        ...
        return r(e,{
            ...
            getCSS:function(a){
                ...
                (c==="shape"?b.offsetTop:0),e=this.left,b=e+this.width,f=d+this.height,d={
...
Mb.prototype={
    ...
    setOffset:function(a,b){
        ...
        f=this.isNegative,g=c.translate(this.percent?100:this.total,0,0,0,1),c=c.translate(0),c=P(g-c),h=d.xAxis[0].translate(this.x)+a,i=d.plotHeight,f={
            x:e?f?g:g-c:h,
...
init:function(a,b){
    ...
    for(f in d)J(this,f,d[f]);if(this.isLog)this.val2lin=ma,this.lin2val=ea
        },
...
defaultLabelFormatter:function(){
    ...
    else if(f&&a>=1E3)for(;f--&&g===v;)c=Math.pow(1E3,f+1),a>=c&&e[f]!==null&&(g=ya(b/c,-1)+e[f]);
...
destroy:function(a){
    ...
    a||aa(b);
    for(d in c)Ja(c[d]),c[d]=null;n([b.ticks,b.minorTicks,b.alternateBands],function(a){
        Ja(a)
        });
...
vb.prototype={
    ...
    runPointActions:function(a){
        ...
        if(d&&this.options.tooltip.shared&&(!g||!g.noSharedTooltip)){
            e=[];
            h=c.length;
            for(i=0;i<h;i++)if(c[i].visible&&c[i].options.enableMouseTracking!==!1&&!c[i].noSharedTooltip&&c[i].tooltipPoints.length&&(b=c[i].tooltipPoints[k],b.series))b._dist=P(k-b.clientX),j=I(j,b._dist),e.push(b);for(h=e.length;h--;)e[h]._dist>j&&e.splice(h,1);
...
wb.prototype={
    ...
    colorizeItem:function(a,b){
        ...
        if(f){
            if(g&&f.isMarker)for(j in g=a.convertAttribs(g),g)d=g[j],d!==v&&(i[j]=d);f.attr(i)
            }
        },
...
Q.prototype={
    ...
    setData:function(a,b){
        ...
        if(i&&m>i){
            ...
            [a[i]]),j[i]=d.x,k[i]=q?this.toYData(d):d.y,l[i]=d.z,h&&d.name))h[d.x]=d.name;da(k[0])&&ua(14,!0);
        this.data=[];
        this.options.data=a;
        this.xData=j;
        this.yData=k;
...
generatePoints:function(){
    ...
    if(b&&(g!==(c=b.length)||j))for(m=0;m<c;m++)if(m===h&&!j&&(m+=g),b[m])b[m].destroyElements(),b[m].plotX=v;this.data=b;
    this.points=l
    },
...
drawPoints:function(){
    ...
    if(l.enabled||this._hasPointMarkers)for(f=b.length;f--;)if(g=b[f],d=S(g.plotX),e=g.plotY,k=g.graphic,i=g.marker||{},a=l.enabled&&i.enabled===v||i.enabled,m=c.isInsidePlot(s(d),e,c.inverted),a&&e!==v&&!isNaN(e)&&g.y!==null)if(a=g.pointAttr[g.selected?"select":""],h=a.r,i=p(i.symbol,this.symbol),j=i.indexOf("url")===0,k)k.attr({
        visibility:m?
    ...
    if(b.enabled||a._hasPointLabels)a.dlProcessOptions&&a.dlProcessOptions(b),g=a.plotGroup("dataLabelsGroup","data-labels",a.visible?"visible":"hidden",b.zIndex||6),e=b,n(c,function(c){
        ...
        if(j&&!i)c.dataLabel=j.destroy();
            ...
            if(j)if(t(f))j.attr({
                ...
                for(l in j)j[l]===v&&delete j[l];j=c.dataLabel=a.chart.renderer[i?"text":

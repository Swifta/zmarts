...
$(document).ready(function() {
	...
	editor = $(".TextArea").cleditor({width:"565px", height:"150px", controls: "bold italic underline strikethrough | font size | color highlight removeformat | bullets numbering | outdent indent | alignleft center alignright justify | undo redo | rule image link unlink", useCSS:false})[0].focus();

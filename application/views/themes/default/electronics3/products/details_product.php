                           ...
                           <div class="clearfix">
                               <?php 
                                ...
                                if($products->deal_status==2){
                                 ...
                                 <?php if ($this->uri->last_segment() != "admin-manage-preview.html" && $this->uri->last_segment() != "merchant-manage-preview.html" && $this->uri->last_segment() != "store-admin-manage-preview.html"){ 
                            ...
                            <div class="deal_share clearfix">
                                <div class="social_share">
                                    <ul>
                                        <li>  <iframe src="http://www.facebook.com/plugins/like.php?href=<?php echo PATH .  $products->store_url_title.'/'; ?> &amp;layout=button_count&amp;show_faces=true&amp;width=450&amp;action=like&amp;colorscheme=light&amp;height=21" scrolling="no" frameborder="0" style="border:none; overflow:hidden;  height:21px; width:82px;" allowTransparency="true"></iframe></li>
                                        <li>
                       ...
                       <?php if(($this->merchant_cms->current()->about_us_status ==1) || ($this->merchant_cms->current()->return_policy_status ==1) || ($this->merchant_cms->current()->terms_conditions_status ==1)) { ?>
                        ...
                        <li>
                            ...
                            <div  class="bid_advance_detail">
								...
								<span><?php echo $this->Lang['FLAT_SHIPP_T_PRO_AMO']; ?>( <?php echo $symbol . " " . number_format($this->userflat_amount); ?> )</span>
								<?php } elseif($products->shipping  == 3){ ?>
								<span><?php echo $this->Lang['PER_PRO_SHIPP_PRODUCT_SHIPP']; ?>( <?php  echo $symbol . " " .number_format($products->shipping_amount); ?> )</span>
								<?php } elseif($products->shipping  == 4){ ?>
								<span><?php echo $this->Lang['PER_ITEM_PRODU_SHIPPING_AMOU']; ?>( <?php  echo $symbol . " " .number_format($products->shipping_amount); ?> )</span>
                                                ...
                                                <?php /*                                            <div class="normal_view">
                                                  ...
                                                  <a title="<?php echo $this->Lang['ADD_TO_CART']; ?>"  onclick="redirect_url('<?php echo $url; ?>');" > <?php echo $this->Lang['ADD_TO_CART']; ?></a>
                                                        ...
                                                        <div class="new_prdt_listing_details">
                                                            ...
                                                            <div class="new_price_details">
																<?php if($products_list->deal_price!=0) { ?>	
																	<p><?php echo $symbol . "" . number_format($products_list->deal_price); ?> </p>
																	<span><?php echo $symbol . "" . number_format($products_list->deal_value); ?></span>
																<?php } else  { ?>
																	<p> </p>
																	<span><?php echo $symbol."".number_format($products_list->deal_value); ?> </span>
																<?php } ?> 
                                                        ...
                                                        <div class="new_list_bottom_icons">
                                                                ...
                                                                <div class="new_cart"><a href="#" title="Add to Cart"></a></div>
                                                        </div>
                                                    </div>
                                                    </div>
                                                </li>
...
<div class="popup_block7" style="display:none;">
	<div class='offer_details'>
		  <h1><?php echo ucfirst($gift_name);?></h1>
                  <a class="offer_close" href="javascript:;"><img src="<?php echo PATH;?>themes/<?php echo THEME_NAME;?>/images/new/compare_close1_gr.png"/></a>

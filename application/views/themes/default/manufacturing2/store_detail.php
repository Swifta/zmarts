...
?>
                <div class="slides">
                        <img src="<?php echo PATH; ?>bootstrap/themes/images/manufacturing2/banners/<?php echo $i; ?>.jpg" alt="" />
                </div>
<?php
                    }
                }
    ...
    <div class="slides">
        <img src="<?php echo PATH; ?>bootstrap/themes/images/manufacturing2/banners/1.jpg" alt="" />
    </div>
    <div class="slides">
        <img src="<?php echo PATH; ?>bootstrap/themes/images/manufacturing2/2.jpg" alt="" />
    </div>
    <div class="slides">
        <img src="<?php echo PATH; ?>bootstrap/themes/images/manufacturing2/3.jpg" alt="" />
    </div>
...
<!-- SLIDER -->
	...
	foreach($this->merchant_personalised_details as $m) {
		 ?>        
                ...
                <div class="offers">
                    <figure>
				<img src="<?php echo PATH; ?>bootstrap/themes/images/manufacturing2/ads/<?php echo $i; ?>.jpg" alt="" />
			</figure>
                </div>
                    <?php }}?> 
            <?php  } } ?>

...
<body>
    <table width="700" cellpadding="0" align="center" cellspacing="0" border="0" bgcolor="#ffffff">
			...
			<td>
				<div style="width:636px;margin:0 auto;">
					 <div style="text-align:center;margin:0 0 20px;padding:10px 0;">
						<strong style="font-size: 20px; font-weight:bold; font-family: Arial;color:#666;"><?php echo $this->Lang['DEAR']." ".$this->Lang["MERCHANT_ACC"].","; ?></strong><br>
						<b style="font-size: 12px; font-weight: normal;font-family: Arial;color:#666;"><?php echo $this->Lang["MER_PRD_MSG"]; ?> </b></td>
					</div>
				 </div>
        </tr>
        <tr>
        ...
        <div style="text-align:center;margin:0 0 20px;padding:10px 0;background:#e2e2e2;">
                            ...
                            <b style="font-size: 12px; font-weight:bold; font-family: Arial;color:#666;"><?php echo $this->Lang['NOTE']; ?>:</b><b style="font-size: 12px; font-weight: normal;font-family: Arial;color:#666;"> <?php echo $this->Lang["MER_PRD_MSG"]; ?> </b>
                        </div>

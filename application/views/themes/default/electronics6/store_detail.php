      ...
      <div class="flexslider" id="mainslider" style="padding: 2px; background:#cccccc;">
        ...
        <!-- <?php  if (count($this->banner_details) > 0) {?>
         ...
         <?php if(!$has_personalized || !$has_banners ){?>
			 <li> 
                <a  href="<?php echo $banner_link;?>"  title = "store banner" target="_blank"> <img src="<?php echo PATH . 'bootstrap/themes/images/electronics6/banners/0_gaming_1_banner.jpg'; ?>" alt="store banner" title="store banner" /> </a>
             </li>
             <li> 
                <a  href="<?php echo $banner_link;?>"  title = "store banner" target="_blank"> <img src="<?php echo PATH . 'bootstrap/themes/images/electronics6/banners/0_gaming_2_banner.jpg'; ?>" alt="store banner" title="store banner" /> </a>
             </li>
		 <?php }?> 

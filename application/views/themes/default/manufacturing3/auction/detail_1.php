    ...
    ?>
        ...
        ?>
                                    ...
                                    <?php } else { if ($deals->deal_status != 0) {?>
                                            ...
                                            <a class="buy_it auction_buy_it button_type_4 bg_scheme_color r_corners tr_all_hover color_light mw_0 m_bottom_15" id="auction"  href="javascript:show_auction('<?php if (isset($this->UserID)) {
                                    echo $this->UserID;
                                } ?>','<?php echo $deals->deal_key; ?>','<?php echo $deals->url_title; ?>');" style=""  title="<?php echo $this->Lang['BID_NOW1']; ?>"><?php echo $this->Lang['BID_NOW1']; ?></a>
                                           
                                            <a class="buy_it auction_buy_it button_type_4 bg_scheme_color r_corners tr_all_hover color_light mw_0 m_bottom_15"  id="sold" title="<?php echo $this->Lang['SOLD_OUT2']; ?>" style="cursor:default;"><?php echo $this->Lang['SOLD_OUT2']; ?></a>
                                    <?php } } ?>                                         
                                    </li>
                                     <?php if ($deals->winner != 0 && $deals->auction_status = 1) {
       ...
       <?php if (count($this->all_deals_list) > 0) { ?>
        ...
        if(($size[0] > PRODUCT_LIST_WIDTH) && ($size[1] > PRODUCT_LIST_HEIGHT)) { ?>
            <img style="margin-left:50px;" src="<?php echo PATH . 'resize.php'; ?>?src=<?php echo PATH . 'images/products/1000_800/' . $deals1->deal_key . '_1' . '.png' ?>&w=<?php echo PRODUCT_LIST_WIDTH; ?>&h=<?php echo PRODUCT_LIST_HEIGHT; ?>" alt="<?php echo $deals1->deal_title; ?>" title="<?php echo $deals1->deal_title; ?>" />
        <?php } else { ?>
         <img style="margin-left:50px; height: 200px;" src="<?php echo PATH .'images/products/1000_800/'.$deals1->deal_key.'_1'.'.png'?>" />
        <?php } ?>
        <?php } else { ?>
            <img style="margin-left:50px;height: 200px;" src="<?php echo PATH; ?>themes/<?php echo THEME_NAME; ?>/images/noimage_products_list.png" alt="<?php echo $deals1->deal_title; ?>" title="<?php echo $deals1->deal_title; ?>" />
        <?php } ?>     
                                        </div>

...
<?php } ?>
    ...
    <?php if (($deals->maximum_deals_limit == $deals->purchase_count) || ($deals->maximum_deals_limit < $deals->purchase_count) || ($deals->enddate < time())) { ?>
                                    <a class="buy_it button_type_4 bg_scheme_color r_corners tr_all_hover color_light mw_0 m_bottom_15" titile="<?php echo $this->Lang['SOLD_OUT2']; ?>" style="cursor:default; background-color:" ><?php echo $this->Lang['SOLD_OUT2']; ?></a>
                        <?php } else { ?>
                         <script type="text/javascript">
                                                        $(document).ready(function() {
                                                        $("#sold").hide();
                                    ...
                                    <a class="buy_it button_type_4 bg_scheme_color r_corners tr_all_hover color_light mw_0 m_bottom_15 " id="auction" href="<?php echo PATH . 'deals_payment/p/' . $deals->deal_key . '/' . $deals->url_title . '.html'; ?>" style="color:white;" title="<?php echo $this->Lang['BUY_NOW2']; ?>"><?php echo $this->Lang['BUY_NOW2']; ?> </a>
                                                        
                                    
                                    <a class="buy_it button_type_4 bg_scheme_color r_corners tr_all_hover color_light mw_0 m_bottom_15" id="sold" titile="<?php echo $this->Lang['SOLD_OUT2']; ?>" style="cursor:default;color:white;" ><?php echo $this->Lang['SOLD_OUT2']; ?></a>
                                    <?php } ?>
                        <?php } ?>

...
<!--                        <a href="#"><img alt="" src="img/product1.jpg"></a>-->
                        ...
                        <div class="pricetag">
                          <span class="spiral"></span><a href="#" class="productcart">Buy Now</a>
                          <div class="price">
                     ...
                     <?php $l++; } ?>
                       ...
                       <?php }else{ ?> 
                              <div class="no_product_found nop"><?php echo $this->Lang['NO_PRODUCT_SOLD_OUT'];?></div>

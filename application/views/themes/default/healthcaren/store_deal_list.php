...
<!--                        <a href="#"><img alt="" src="img/product1.jpg"></a>-->
            ...
            <?php } ?> 
                ...
                ?></h5>
                        ...
                        <div class="pricetag">
                          <span class="spiral"></span><a href="<?php echo PATH . $deals_categories->store_url_title . '/deals/' . $deals_categories->deal_key . '/' . $deals_categories->url_title . '.html'; ?>" class="productcart">ADD TO CART</a>
                          <div class="price">

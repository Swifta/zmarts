...
<html xmlns="http://www.w3.org/1999/xhtml">
   ...
   <body>
  <!-- Start of preheader -->
<table width="100%" bgcolor="" cellpadding="0" cellspacing="0" border="0" id="backgroundTable" st-sortable="preheader" >
   <tbody>
      <tr>
         <td>
...
<!-- End of preheader -->      
<!-- Start of header -->
<table width="100%" bgcolor="" cellpadding="0" cellspacing="0" border="0" id="backgroundTable" st-sortable="header">
   <tbody>
      <tr>
         <td>
            <table width="560" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
               <tbody>
                  <tr>
                     <td width="100%">
                        <table bgcolor="#FCFCFC" width="560" cellpadding="0" cellspacing="0" border="0" align="center" style="border-top-left-radius:5px;border-top-right-radius:5px;" class="devicewidth">
                           <tbody>
                              <!-- Spacing -->
                              <tr>
                                 ...
                                 <td>
                                    ...
                                    <table width="194" align="left" border="0" cellpadding="0" cellspacing="0">
                                       <tbody>
                                          <tr>
                                             <td width="20"></td>
                                             <td width="170" height="60" align="">
                                                <div class="imgpop">
                                                   <a target="_blank" href="#">
                                                   <img src="https://zmart.com.ng/themes/default/images/logo.png" alt="" width="140" height="45" style="display:block; border:none; outline:none; text-decoration:none;"/>
                                                   </a>
                                                </div>
                                             </td>
                                          </tr>
                           ...
                           <tbody>
                              <tr>
                                 ...
                                 <td align="center" st-image="banner-image">
                                    <div class="imgpop">
                                       <a target="_blank" href="#"><img width="560" border="0" height="300" alt="" border="0" style="display:block; border:none; outline:none; text-decoration:none;" 
                                                                        src="<?php echo PATH.'images/newsletter/'.$this->news_logo; ?>" class="banner"/></a>
                                    </div>
                                 </td>
                              </tr>
                           </tbody>
...
<!-- End of main-banner -->
<!-- 3-columns -->  
<table width="100%" bgcolor="#" cellpadding="0" cellspacing="0" border="0" id="backgroundTable">
         ...
         <td>
            <table width="560" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
               <tbody>
                  <tr>
                     <td width="100%">
                        <table bgcolor="#FCFCFC" width="560" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
                           <tbody>
                              <!-- Spacing -->
                              <tr>
...
<?php } ?>
                                          ...
                                          <tr>
                                            <td style="font-family: Helvetica, arial, sans-serif;font-weight:bold; font-size: 24px; color: #2d2a26; text-align:left; line-height: 24px;">
<?php echo htmlspecialchars($_POST['title'], ENT_QUOTES,"UTF-8");?>
                                             </td>
                                          </tr>
                                          <!-- Spacing -->
                                          <tr>
...
<?php if(isset($this->news_message)){
...
<p style="text-align:center; font-size:80%;">
     ...
     <?php echo htmlspecialchars($_POST['footer'], ENT_QUOTES,"UTF-8"); ?>
 </p>
                                             </td>
                                          </tr>
                                          <!-- end of content -->
                              ...
                              <!-- Spacing -->
                              <tr>
                                 <td height="5" bgcolor="" style="font-size:1px; line-height:1px; mso-line-height-rule: exactly;">&nbsp;</td>
                              </tr>
                              <!-- Spacing -->
                           </tbody>
                        </table>
...
<!-- end of fulltext -->
<!-- Start of footer -->
<table width="100%" bgcolor="" cellpadding="0" cellspacing="0" border="0" id="backgroundTable" st-sortable="footer">
   <tbody>
      <tr>
         <td>
            <table width="560" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
               <tbody>
                  <tr>
                     <td width="100%">
                        <table bgcolor="#FaFaFa" width="560" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
                           <tbody>
                              <!-- Spacing -->
                              <tr>
                                 <td height="10" style="font-size:1px; line-height:1px; mso-line-height-rule: exactly;">&nbsp;</td>

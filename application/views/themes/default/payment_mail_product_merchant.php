...
<table width="700" cellpadding="0" align="center" cellspacing="0" border="0" bgcolor="#ffffff">
  <tr height="63">
    <td valign="middle" align="left"><div style="margin:0 auto;width:636px;"> <a style="text-decoration:none" href="http://localhost/zmarts/" title="E-Marketplace"> <img src="http://localhost/zmarts/themes/default/images/logo.png"  alt="E-Marketplace"  /> </a> </div></td>
  </tr>
  <tr >
    <td colspan="7">
    <table width="100%"  style="text-align:left; padding:15px;margin:0 0 20px; background:#e2e2e2;">
        <tr>
          <td><strong style="font-size: 13px; font-weight:bold; font-family: Arial;color:#666;">Dear <?php echo $this->merchant_firstneme; ?> <?php echo $this->merchant_lastname; ?>,</strong></td>
           <tr>
           <td  style="font-family:Arial, Helvetica, sans-serif; font-weight:normal; font-size:12px;"> You have receive an order on <a style="text-decoration:none" href="<?php echo PATH; ?>"><?php echo SITENAME; ?></a> with the following details.</td>
        </tr>
      </table>
  </tr>
    <tr>
  ...
  <table cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr>
      <td><table cellpadding="0" cellspacing="0" width="100%">
          <tr height="30" valign="middle" style="background: #eaeaea;font-size: 12px; font-weight:bold; font-family: Arial;color:#666;">
            <td width="80%" align="left" style="padding:10px; border-bottom: solid 1px #000000;"><span style="padding-right: 15px;">Customer Details</span></td>
          </tr>
        </table></td>
    </tr>
    ...
    <tr>
      <td><table class="printtable" cellpadding="0" cellspacing="0" width="100%">
          <tbody>
            ...
            <tr style="font-size: 12px; font-weight:bold; font-family: Arial;color:#666;">
              <td width="13%" align="center">Buyer Name: </td>
              <td width="13%" align="center" style="font-size:12px;font-weight:normal;font-family:Arial;color:#666"><?php echo ucfirst($merchant_lastname); ?></td>
              <td width="13%" align="center"> Email: </td>
              <td width="13%" align="center" style="font-size:12px;font-weight:normal;font-family:Arial;color:#666"><?php echo $merchant_email; ?></td>
              <td width="13%" align="center">phone: </td>
              <td width="13%" align="center" style="font-size:12px;font-weight:normal;font-family:Arial;color:#666"><?php echo $merchant_phone; ?></td>
            </tr>
        </table></td>
    </tr>
    <tr>
    ...
    <table cellpadding="0" cellspacing="0" width="100%">
      <tbody>
        <tr>
          <td colspan=""><table cellpadding="0" cellspacing="0" width="100%">
              <tr height="30" valign="middle" style="background: #eaeaea;font-size: 12px; font-weight:bold; font-family: Arial;color:#666;">
                <td width="80%" align="left" style="padding:10px; border-bottom: solid 1px #000000;"><span style="padding-right: 15px;">Transaction Details</span></td>
              </tr>
            </table></td>
        </tr>
        <tr>
          <td><table class="printtable" cellpadding="0" cellspacing="0" width="100%">
              <tbody>
                ...
                <tr style="font-size: 12px; font-weight:bold; font-family: Arial;color:#666;">
                  <td width="13%" align="center">Transaction id: </td>
                  <td width="13%" align="center" style="font-size:12px;font-weight:normal;font-family:Arial;color:#666">  <?php echo $p->transactionid; ?></td>
                  <td width="13%" align="center"> Order date: </td>
                  <td width="13%" align="center" style="font-size:12px;font-weight:normal;font-family:Arial;color:#666"><?php echo date('d-m-Y H:i:s A',$p->transaction_date); ?></td>
                  <td width="13%" align="center">Delivery: </td>
                  <td width="13%" align="center" style="font-size:12px;font-weight:normal;font-family:Arial;color:#666"><?php echo $p->delivery_period." ".$this->Lang['DELI_DAYS']; ?></td>
                </tr>
            </table>
            <br>
            <table cellpadding="0" cellspacing="0" width="100%">
              <tr height="30" valign="middle" style="background: #eaeaea;font-size: 12px; font-weight:bold; font-family: Arial;color:#666;">
                <td width="80%" align="center" style="padding:10px"><span style="padding-right: 15px;">Shipping Address:</span> <?php echo $c_name.", "; ?><span style="font-size:12px;font-weight:normal;font-family:Arial;color:#666"> <?php echo $c_addr1?>, <?php echo " ".$c_addr2?>, <?php echo  " ".$c_city.", "; ?> - <?php echo $c_zipcode." ".$c_state.", "; ?> <?php echo $c_country?>.</span></td>
              </tr>
            </table></td>
        </tr>
        <tr>
        ...
        <tr>
          <td><table cellpadding="0" cellspacing="0" width="100%">
              <tr height="30" valign="middle" style="background: #eaeaea;font-size: 12px; font-weight:bold; font-family: Arial;color:#666;">
                <td width="80%" align="left" style="padding:10px; border-bottom: solid 1px #000000;"><span style="padding-right: 15px;">Ordered Item(s)</span></td>
              </tr>
            </table></td>
        </tr>
          <tr>
        ...
        <table cellpadding="0" cellspacing="0" width="100%">
          ...
          <table cellpadding="0" cellspacing="0" width="100%">
            ...
            <?php
             ...
             <!-- <td width="13%" align="center">&#8358;150</td>-->
         ...
         <td>
          ...
          <table cellpadding="0" cellspacing="0" width="100%">
            <tr height="30" valign="middle" style=" background: #eaeaea;font-size: 12px; font-weight:bold; font-family: Arial;color:#666;">
            <td width="40%" align="center" style=" padding:10px; border-right:#000  dotted 1px" ><?php echo $ship_dispay; ?>
                                    <?php if(($u->shipping_methods != 1) && ($u->shipping_methods != 5) ){ ?>
                                    ( <?php echo CURRENCY_SYMBOL.$u->shipping; ?> )
                                    <?php } ?></td>
             <!-- <td width="40%" align="left" style=" padding:10px; border-right:#000  dotted 1px">Free shipping on this product.</td>-->
              <td width="40%"style=" padding:10px;" align="left">Store: <a style="text-decoration:none" href="<?php echo PATH.$u->store_url_title;?>"><?php echo $u->store_name; ?></a></td>
  ...
  <div style="width: 100%;  line-height: 2em; text-align:left; page-break-before: auto;">
    ...
    <table class="printtable" cellpadding="0" cellspacing="0" width="100%">
      ...
      <tr><td width="74%">&nbsp;</td></tr>
      
      <tr>
      
      <td width="618" colspan="7" width="100%" align="center" style="text-align:center; color:#AAA; font-family:Arial, Helvetica, sans-serif; font-size:12px" >You received this message because you are a member on  <a style="text-decoration:none" href="<?php echo PATH; ?>"  ><?php echo SITENAME; ?> </a></td>
  ...
  <!--<tr height="80" bgcolor="#e2e2e2">
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="color:#777;font-size: 14px;font-family: arial; text-align:center; padding: 25px;">
        <tr>
          <td width="618" colspan="7" align="center" style="text-align:center">You received this message because you are a member of  <a href="<?php echo PATH; ?>"  ><?php echo SITENAME; ?> </a></td>
        </tr>

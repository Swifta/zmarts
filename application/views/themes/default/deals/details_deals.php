                        ...
                        <?php } ?>
							...
							<div class="chat_opt">
                                ...
                                <?php if($deals->online_status==1) { ?>
									<a class="online_txt" <?php   if($this->session->get("chatuserid")) {  ?> href="javascript:chatWith('<?php echo $deals->firstname; ?>','<?php echo $deals->user_id; ?>',2);" <?php } else { ?> href="javascript:chat_detail_popup('<?php echo $deals->firstname; ?>','<?php echo $deals->user_id; ?>');" <?php } ?> title="<?php echo $this->Lang["ON_LINE"]; ?>"><?php echo $this->Lang["ON_LINE"]; ?></a>
                                <?php } else { ?>

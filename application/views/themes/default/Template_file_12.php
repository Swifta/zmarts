                                       ...
                                       <tbody>
                                          <tr>
                                             ...
                                             <td width="30" height="30" align="center">
                                                <div class="imgpop">
                                                   <a target="_blank" href="#">
                                                   <img src="img/googleplus.png" alt="" border="0" width="30" height="30" style="display:block; border:none; outline:none; text-decoration:none;">
                                                   </a>
                                                </div>
                                             </td>
                                             <td align="left" width="20" style="font-size:1px; line-height:1px;">&nbsp;</td>
                                             <td width="30" height="30" align="center">
                                                <div class="imgpop">
                                                   <a target="_blank" href="#">
                                                   <img src="img/instagram.png" alt="" border="0" width="30" height="30" style="display:block; border:none; outline:none; text-decoration:none;">
                                                   </a>
                                                </div>
                                             </td>
                                          </tr>
                                       ...
                                       <tbody>
                                          <tr>
                                             <td width="169" height="45" align="center">
                                                <div class="imgpop">
                                                   <a target="_blank" href="#">
                                                   <img src="https://zmart.com.ng/themes/default/images/logo.png" alt="" border="0" width="169" height="45" style="display:block; border:none; outline:none; text-decoration:none;"/>
                                                   </a>
                                                </div>
                                             </td>
                                          </tr>
                           ...
                           <tbody>
                              <tr>
                                 ...
                                 <td align="center" st-image="banner-image">
                                    <div class="imgpop">
                                        <a target="_blank" href="#">
                                            <img width="600" border="0" height="300" alt="" border="0" style="display:block; border:none; outline:none; text-decoration:none;" 
                                 ...
                                 <td>
                                    <table width="560" align="center" cellpadding="0" cellspacing="0" border="0" class="devicewidthinner">
                                       <tbody>
                                          <!-- Title -->
                                          <tr>
                                             <td style="font-family: Helvetica, arial, sans-serif; font-size: 18px; color: #333333; text-align:left; line-height: 30px;" st-title="fulltext-heading">
...
<?php } ?>
                                          ...
                                          <!-- Salutation and name -->
                                          <tr>
                                             <td style="font-family: Helvetica, arial, sans-serif; font-size: 25px; color:#666666; text-align:left; line-height: 30px;" st-title="fulltext-heading">
                                                <?php echo htmlspecialchars($_POST['title'], ENT_QUOTES,"UTF-8");?>
                                             </td>
                                          </tr>
                                          <!-- Saalutation and name -->                                          
                                          <!-- spacing -->
                                          <tr>

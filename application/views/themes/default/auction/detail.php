...
<a <?php   if($this->session->get("chatuserid")) {  ?> href="javascript:chatWith('<?php echo $deals->firstname; ?>','<?php echo $deals->user_id; ?>',2);" <?php } else { ?> href="javascript:chat_detail_popup('<?php echo $deals->firstname; ?>','<?php echo $deals->user_id; ?>');" <?php } ?> title="<?php echo $this->Lang["ON_LINE"]; ?>"><?php echo $this->Lang["ON_LINE"]; ?></a>
<?php } else { ?>
<a href="javascript:chat_offline(<?php echo $deals->user_id; ?>,2);" title="<?php echo $this->Lang["OFF_LINE"]; ?>"><?php echo $this->Lang["OFF_LINE"]; ?></a>
<?php } ?>	
</p>
<?php /* Chat ends here */ ?>
</div>
                     ...
                     <ul class="bid_advance_block">
                        <li>
                            ...
                            <div  class="bid_advance_detail">
                                ...
                                <span><?php echo $symbol . " " . number_format($deals->deal_value); ?></span>
                            </div>
                            <div  class="bid_advance_detail">
                                <label><?php echo $this->Lang['BID_INCR']; ?> :</label>
                                <span><?php echo $symbol . " " . number_format($deals->bid_increment); ?></span>
                        ...
                        <li>
                            ...
                            <div  class="bid_advance_detail">
                                ...
                                <span><?php echo $symbol . " " . number_format($deals->shipping_fee); ?></span>
                            </div>
                            <div  class="bid_advance_detail">
                                                                            ...
                                                                            <div class="place_midd_bott clearfix">
                                                                                ...
                                                                                <div class="place_bott_mid">
                                                                                    ...
                                                                                    <div class="place_bot_center">
                                                                                        ...
                                                                                        <p></p>
                                                                                        <span class="bidamountval1">(<?php echo $symbol . " "; ?><?php echo number_format($deals->deal_price); ?> <?php echo $this->Lang['OR_MORE']; ?>)</span>
                                                                                    </div>
                                ...
                                <?php $url = PATH . $deals1->store_url_title.'/auction/' . $deals1->deal_key . '/' . $deals1->url_title . '.html'; ?>                                                
                                    ...
                                    <div class="list_bottom">
                                        ...
                                        <div class="new_list_bottom_icons">
                                            <ul>
                                                <li class="new_bid"><a  href="" title="<?php echo $this->Lang['BID_NOW1']; ?>" onclick="redirect_url('<?php echo $url; ?>');"><?php // echo $this->Lang['BID_NOW1']; ?></a> </li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>

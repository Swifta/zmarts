                                    ...
                                    <ul>
                                       ...
                                       <li>
										...
										<li>
												...
												<div class="fullname"><input tabindex="9" id="ship_phone_pay1" name="phone" size="40" AUTOCOMPLETE="OFF"  placeholder="Your Phone Number (e.g. 070..,080..)" type="text" value="" class="required number" maxlength="18"/></div>
										</li>

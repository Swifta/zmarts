                                    ...
                                    <ul>
                                       ...
                                       <li>
										...
										<li>
												...
												<div class="fullname"><input tabindex="9" id="ship_phone_cod1" name="phone" size="40" AUTOCOMPLETE="OFF"  placeholder="e.g. 080..., 070..." type="text" value="" class="required number" maxlength="18"/></div>
										</li>

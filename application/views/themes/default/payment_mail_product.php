                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="80%" valign="top">
                                                                ...
                                                                <td width="80%" align="center"><?php echo $ship_dispay; ?> <?php if(($u->shipping_methods != 1) && ($u->shipping_methods != 5) ){ ?> ( <?php echo CURRENCY_SYMBOL.$u->shipping; ?> )  <?php } ?></td>
                                                                 ...
                                                                 <tr height="30" valign="middle" style="background: #eaeaea;font-size: 12px; font-weight:bold; font-family: Arial;color:#666;">
                                                                <td width="80%" align="center"><?php echo "Offer : ".$this->Lang['BUY_ONE']. "  ".$u->bulk_discount_buy."  ".$this->Lang['GET']."  ".$u->bulk_discount_get;?>(<?php echo $this->Lang['YOU_GOT_DISCOUNT'];?> <?php echo $u->total_discount+$u->quantity;?><?php echo " ".$this->Lang['PRODUCTS'];?>)</td></tr>
                                                                <?php } ?>
															 ...
															 <td width="100%" colspan="2">
																 <div style="width:100%">
																	...
																	<?php if(file_exists(DOCROOT.'images/merchant/gift/'.$this->gift->current()->gift_id.'.png')){?>
																	  <div class="offer_det_left" style="float:left;width:18%;margin-right:2%;">
																		 <img src="<?php echo PATH.'images/merchant/gift/'.$this->gift->current()->gift_id.'.png';?>">
																	  </div>
																	  <?php }?>
																	  <div style="float:left;width:80%;" <?php if(!file_exists(DOCROOT.'images/merchant/gift/'.$this->gift->current()->gift_id.'.png')){?> style="width:100%" <?php }?>>
			...
			$j++; } ?>
                        ...
                        <tr>
                            <td style="padding:15px 0;">
                                ...
                                <div style="float:left; font-size:12px; text-align: center;margin-left:25px;">
                                        <strong style="font-size: 20px;font-family: arial;font-weight: bold;color: #666; text-align: center;display:block;"><?php echo $this->Lang['PAY_LATER']; ?></strong>
                                        <div style="float:left;">
                                            <span style="font-size: 12px;font-family: arial;color: #666;float:left;">
												<b style="padding-top:5px;display:block;"> <?php echo PAY_LATER; ?></b>
											</span>
                                        </div>
									</div>
								</div>

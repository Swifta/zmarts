...
<div class="container" style="background-color:#ffffff;">
	...
	<div class="tp-banner-container" style="background-color:#ffffff;">
		<div class="tp-banner">
			<ul>
<?php
$arr_effects = array();
...
?>
                <li data-transition="<?php echo $arr_effects[$i-1]; ?>" data-slotamount="7" data-masterspeed="1500" >
                        <img src="<?php echo PATH; ?>bootstrap/themes/images/agriculture1/banners/<?php echo $i; ?>.jpg" alt="" />
                </li>
<?php
                    }
                }
    ...
    <li data-transition="<?php echo $arr_effects[0]; ?>" data-slotamount="7" data-masterspeed="1500" >
            <img src="<?php echo PATH; ?>bootstrap/themes/images/agriculture1/banners/1.jpg" alt="" 
                 data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat"/>
    </li>
    <li data-transition="<?php echo $arr_effects[1]; ?>" data-slotamount="7" data-masterspeed="1500" >
            <img src="<?php echo PATH; ?>bootstrap/themes/images/agriculture1/banners/2.jpg" alt="" 
                 data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat"/>
    </li>
    <li data-transition="<?php echo $arr_effects[2]; ?>" data-slotamount="7" data-masterspeed="1500" >
            <img src="<?php echo PATH; ?>bootstrap/themes/images/agriculture1/banners/3.jpg" alt="" 
                 data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat"/>
    </li>
...
<!-- Featured
================================================== -->
<div class="container" style="background-color:#ffffff; margin-top:-50px;padding-top:30px;" >
            <?php 
            $ads_check = "";
            if(count($this->merchant_personalised_details)>0) { 
	foreach($this->merchant_personalised_details as $m) {
		 ?>        
            <div class="advertice_part" style="background-color:#ffffff;">
                <ul>
					<?php for ($i = 1; $i <= 3; $i++) { ?>
...
<!-- Product Lists
================================================== -->
<div class="container margin-bottom-25" style="background-color:#ffffff;">
...
<div class="margin-top-50" style="background-color:#ffffff;"></div>

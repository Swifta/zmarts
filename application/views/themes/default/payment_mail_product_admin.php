...
<!--<table width="700" cellpadding="0" align="center" cellspacing="0" border="0" bgcolor="#ffffff">
  ...
  <tr>
    <td><div style="width:636px;margin:0 auto;">
        <div style="text-align:center;margin:0 0 20px;padding:30px 0;background:#e2e2e2"> <strong style="font-size:20px;font-weight:bold;font-family:Arial;margin-left:20px;color:#666"><?php echo $this->Lang['DEAR']; ?> <?php echo $this->merchant_firstname; ?> <?php echo $this->merchant_lastname; ?>,</strong><br>

...
<?php
    ...
    $this->customer_details = $this->creditcard_paypal_pay->get_usr_details();												
    $customer_firstname = $this->customer_details->current()->firstname;
    $customer_lastname = $this->customer_details->current()->lastname;
    $customer_email = $this->customer_details->current()->email; 
    $customer_phone =   $this->customer_details->current()->phone_number; ?>
    ...
    <td colspan="7" ><table class="printtable" cellpadding="0" cellspacing="0" width="100%;" >
        <tbody>
          ...
          <tr style="font-size: 12px; font-weight:bold; font-family: Arial;color:#666; width:100%">
            ...
            <td align="left"  style="padding:10px; font-size:12px;font-weight:normal;font-family:Arial;color:#666;"><?php echo ucfirst($customer_firstname);?> <?php echo ucfirst($customer_lastname);?>&nbsp;</td>
            ...
            <td align="left"   style="padding:10px;">Phone Number: </td>
            <td align="left"  style="padding:10px; font-size:12px;font-weight:normal;font-family:Arial;color:#666;"><?php echo $p->phone; ?>&nbsp;</td>
          </tr>
        </tbody>
      </table></td>
  </tr>
...
<tr height="30" valign="middle" style="background: #eaeaea;font-size: 12px; font-weight:bold; font-family: Arial;color:#666;">
        ...
        <?php if($u->shipping_methods == 5){ 
              ...
              <!--<tr height="30" valign="middle" style="background: #eaeaea;font-size: 12px; font-weight:bold; font-family: Arial;color:#666;">
                <td width="40%" colspan="4" align="center" style="border-right:#000  dotted 1px;"><?php echo $ship_dispay; ?>
        ...
        <tr height="30"  valign="middle" style=" background: #eaeaea;font-size: 11px; font-weight:bold; font-family: Arial;color:#666;">
         ...
         <!-- <td  colspan="3" style="border-top: 1px solid #000; padding:10px;" align="left">Address: <a style="text-decoration:none" href="#"><?php echo $store_payment_details->address1.", ".$store_payment_details->city.", ".$store_payment_details->country; ?></a></td>
          <td  colspan="2" style="border-top: 1px solid #000; padding:10px;" align="left">Phone: <a style="text-decoration:none" href="#"><?php echo $store_payment_details->phone; ?></a></td>-->
              ...
              <tr height="30" valign="middle" style="background: #eaeaea;font-size: 12px; font-weight:bold; font-family: Arial;color:#666;">
                <td width="80%" colspan="8" align="center"><?php echo "Offer : ".$this->Lang['BUY_ONE']. "  ".$u->bulk_discount_buy."  ".$this->Lang['GET']."  ".$u->bulk_discount_get;?>(<?php echo $this->Lang['YOU_GOT_DISCOUNT'];?> <?php echo $u->total_discount+$u->quantity;?><?php echo " ".$this->Lang['PRODUCTS'];?>)</td>
              </tr>
              <?php } ?>
              ...
              <tr height="30" valign="middle" style="background: #eaeaea;font-size: 12px; font-weight:bold; font-family: Arial;color:#666;">
                <td colspan="8"><div style="width:100%; padding:10px; overflow:hidden;">
                    <h1 style="font:14px arial;color:#5BB110;padding-bottom:5px;border-bottom:1px dashed #ddd;float:left;width:98%;margin-bottom:10px;"><?php echo $this->Lang['GIFT'].' : '.$this->gift->current()->gift_name; ?></h1>
                    ...
                    <div style="float:left;width:100%;">
                      <p style="float:left;font:12px/19px arial;color:#888;width:100%;"><?php echo common::truncate_item_name(ucfirst($this->gift->current()->gift_description), 100)?></p>
                    </div>
                  </div>
                  <?php }?></td>
              </tr>
              ...
              <tr height="30" valign="middle" style="background: #eaeaea;font-size: 12px; font-weight:bold; font-family: Arial;color:#666;">
                <td width="80%" colspan="8" align="center"><?php echo "Store Credits : ".$u->store_credit_period." Months"; ?></td>
              </tr>
              <?php } ?>
              <?php if($u->shipping_methods == 5){ ?>
              <tr height="30" valign="middle" style="background: #eaeaea;font-size: 12px; font-weight:bold; font-family: Arial;color:#666;">
                <td width="40%" colspan="4" align="center"><?php echo $this->Lang['CUUR_CODE']; ?> ( <?php echo $u->aramex_currencycode; ?> ) </td>
                <td width="40%" colspan="4" align="center"><?php echo $this->Lang['ARAMEX_COST']; ?> ( <?php echo $u->aramex_value; ?> ) </td>
              </tr>
              <?php } ?>
  ...
  <div style="width:100%;  line-height: 2em; text-align:left; page-break-before: auto;">
    ...
    <div style="clear:both;"></div>
    <div style="float:left; width: 48%">&nbsp;</div>
    <div style="float:left; width: 26%; text-align:right; color:#144F5D; font: bold 12px arial; white-space:nowrap;"><?php echo $this->Lang['SHIP_ING']; ?></div>
 ...
 <!--- Last gray row -->
  ...
  <?php /*<div style="float:left; width: 72%">&nbsp;</div>
    ...
    <!--<tr height="30" valign="middle" style="background: #eaeaea;font-size: 12px; font-weight:bold; font-family: Arial;color:#666; width:100%;">
      <td colspan="4">&nbsp;</td>
      <td colspan="2"  align="right" style=" padding:15px; color:#144F5D; font: bold 12px arial; white-space:nowrap" ><?php if($p->type == 5 || $p->type == 6 ) { echo $this->Lang['AMO_TO_B_PAID']; } else { echo $this->Lang['AMTPAID']; } ?></td>
      <td colspan="2" align="center" style=" padding:15px; color:#666666; font: bold 12px arial; white-space:nowrap"><?php echo CURRENCY_SYMBOL.$grand_tot; ?></td>
    </tr>-->
 
  
  <tr>
    <td colspan="8" style="padding:15px 0;"><div style="margin:0 auto;">
      <div style="width:100%;"> 
       <!-- <div style="float:left; width: 40%; font-size:12px; border-right: 1px dotted #666666; text-align: center;">
        ...
        <?php if(isset($this->set_pay_later) && $this->set_pay_later==1 && $p->type == 6){?>

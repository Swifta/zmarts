                ...
                <td width="568">
                    <table width="568" cellpadding="0" cellspacing="0" border="0" style="padding: 15px 10px;">                        
                        <tr><td width="100%" align="center">
							<img src="<?php echo PATH.'images/newsletter/'.$_FILES['attach']['name']; ?>"  alt="<?php echo SITENAME; ?>"  style="width:320px;height:35px;"/></td></tr>
					   ...
					   <?php } ?></td></tr>
                        ...
                        <tr><td width="100%" align="center" style="font:bold 13px arial;color:#000;"><?php echo htmlspecialchars($_POST['title'], ENT_QUOTES,"UTF-8");?></td></tr>
                        ...
                        <tr><td width="100%" align="center" style="font:bold 12px arial;color:#a61c00;"><?php echo htmlspecialchars($_POST['footer'], ENT_QUOTES,"UTF-8");?></td></tr>
                    </table>
                </td>
                <td style="padding:8px;background: #d4fede;"></td>
            </tr>

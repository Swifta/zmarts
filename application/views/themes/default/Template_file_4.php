                ...
                <td width="568">
                    <table width="568" cellpadding="0" cellspacing="0" border="0" style="padding: 15px 10px;">                        
					   ...
					   <?php } ?></td></tr>
                        ...
                        <tr><td width="100%" align="center" style="font:bold 13px arial;color:#000;"><?php echo htmlentities($_POST['title'],  ENT_QUOTES,  "utf-8");?></td></tr>
                        ...
                        <tr><td width="100%" align="center" style="font:bold 12px arial;color:#a61c00;"><?php echo htmlentities($_POST['footer'], ENT_QUOTES,  "utf-8");?></td></tr>
                    </table>
                </td>
                <td style="padding:8px;background: #d4fede;"></td>
            </tr>

...
if(count($this->merchant_personalised_details)>0) { 
	foreach($this->merchant_personalised_details as $m) {  ?>
          ...
          <li>                                                                          
            <a href="<?php echo $banner_link; ?>" href="slide<?php echo $i; ?>" title = "<?php echo $banner_link; ?>">
                <img alt="<?php echo $this->Lang['LOGO']; ?>" style="width:680px;" src="<?php echo PATH; ?>images/merchant/banner/<?php echo $m->storeid.'_'.$m->sector_name.'_'.$i.'_banner.png'; ?>"/>
            </a>
          </li>
        <div class="slider-detils">
            <h3>Story <label>..</label></h3>
            <span>..game day.</span>
            <a class="slide-btn" href="details.html"> Shop Now</a>
                                        ...
                                        <?php $tabs++;} ?>
                                            ...
                                            if($tabs==0){ ?>
          <li> 
		<img alt="Banner image" style="width:680px;" src="<?php echo PATH; ?>themes/<?php echo THEME_NAME ?>/images/fashion_banner.png"/>
          </li>
        <div class="slider-detils">
            <h3>Story <label>..</label></h3>
            <span>..game day.</span>
...
<div class="content" style="<?php echo $bg_color; ?>">
    <div class="wrap">
        <!--<div class="contianer">-->
...
<div class="bottom-top-grid <?php if($i==2){echo 'last-bottom-top-grid';} ?>">
...
<?php } ?>
                                            ...
                                            <p style="font:18px arial;color: #000;"><?php echo $symbol . " " . number_format($best->deal_value); ?></p>
                                        </div>
                                    </div>                                    
                                </li>
                                <?php } ?>

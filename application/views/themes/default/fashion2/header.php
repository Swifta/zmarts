...
?>
<!--<script src="<?php echo PATH; ?>themes/<?php echo THEME_NAME; ?>/css/<?php echo $this->theme_name; ?>/js/jquery.min.js"  type="text/javascript"></script>-->
<script src="<?php echo PATH; ?>themes/<?php echo THEME_NAME; ?>/css/<?php echo $this->theme_name; ?>/js/jquery.easy-ticker.js"  type="text/javascript"></script>
<script src="<?php echo PATH; ?>themes/<?php echo THEME_NAME; ?>/css/<?php echo $this->theme_name; ?>/js/megamenu.js"  type="text/javascript"></script>
<script src="<?php echo PATH; ?>themes/<?php echo THEME_NAME; ?>/css/<?php echo $this->theme_name; ?>/js/menu_jquery.js"  type="text/javascript"></script>
<script src="<?php echo PATH; ?>themes/<?php echo THEME_NAME; ?>/css/<?php echo $this->theme_name; ?>/js/jquery-ui.js"  type="text/javascript"></script>
<script src="<?php echo PATH; ?>themes/<?php echo THEME_NAME; ?>/css/<?php echo $this->theme_name; ?>/js/scripts-f0e4e0c2.js"  type="text/javascript"></script>
<script src="<?php echo PATH; ?>themes/<?php echo THEME_NAME; ?>/css/<?php echo $this->theme_name; ?>/js/jquery-ui.min.js"  type="text/javascript"></script>
<script src="<?php echo PATH; ?>themes/<?php echo THEME_NAME; ?>/css/<?php echo $this->theme_name; ?>/js/move-top.js"  type="text/javascript"></script>
<script src="<?php echo PATH; ?>themes/<?php echo THEME_NAME; ?>/css/<?php echo $this->theme_name; ?>/js/easing.js"  type="text/javascript"></script>
...
<!--				<li><a  href="<?//php echo PATH . 'merchant-login.html'; ?>" title="<?//php  echo $this->Lang['MER_LOIN']; ?>"><?//php echo $this->Lang['MER_LOIN']; ?></a></li>
        ...
        <div class="header-bottom"> <!-- started customization of menu here-->
        <div class="wrap">                                                                                               
		        ...
		        <?php } ?>
			        ...
			        <li <?php
				        ...
				        <a class="color2" href="<?php echo PATH.$this->storeurl; ?>" title="<?php echo $this->Lang['HOME']; ?>"><?php echo $this->Lang['HOME']; ?>
				        </a>
        ...
        <li class="grid <?php if (isset($this->is_product)) echo "active"; ?>"> <a class="color2" href="<?php echo PATH.$this->storeurl; ?>/products.html" title="<?php echo $this->Lang['PRODUCTS']; ?>"><?php echo $this->Lang['PRODUCTS']; ?>
				...
				<?php if($this->categeory_list_product){  
					foreach ($this->categeory_list_product as $d) {
						...
						if(($check_sub_cat !=-1 )&&($check_sub_cat !=0)) { ?>
							<div class="col1">
                                                            <div class="h_nav">
								<h4 class="top"><?php echo ucfirst($d->category_name); ?></h4>
								<ul>
									<?php if(count($this->subcategories_list)>0){
										$hdn_second_cnt = 1;
										foreach($this->subcategories_list as $sub_cate){
       ...
       <?php /* <i class="hover_icon">&nbsp;</i>
        ...
        <li class=" grid <?php if (isset($this->is_todaydeals)) echo "active"; ?> "><a class="color2" href="<?php echo PATH.$this->storeurl; ?>/today-deals.html" title="<?php echo $this->Lang['DEALS']; ?>">
				...
				<?php if($this->categeory_list_deal){  
					foreach ($this->categeory_list_deal as $d) {
						...
						if(($check_sub_cat !=-1 )&&($check_sub_cat !=0)) { ?>
							<div class="col1">
                                                            <div class="h_nav">
								<h2 class="top"><?php echo ucfirst($d->category_name); ?></h2>
								<ul>
									<?php if(count($this->subcategories_list)>0){
										$hdn_second_cnt = 1;
										foreach($this->subcategories_list as $sub_cate){
									...
									<?php $hdn_second_cnt++;}
									if($hdn_second_cnt==5){?>
									<li><a href="javascript:filtercategory_store('<?php echo $d->category_url; ?>', 'deal', '<?php echo base64_encode("main"); ?>','<?php echo $this->storeurl; ?>');" title="<?php echo ucfirst($sub_cate->category_name);?>"><?php echo $this->Lang['VIW_MRE'];?></a></li> 
									<?php break;}
									}
       ...
       <?php /* <i class="hover_icon">&nbsp;</i>
        ...
        <li class="grid <?php if (isset($this->is_auction)) echo "active"; ?>"><a class="color2" href="<?php echo PATH.$this->storeurl; ?>/auction.html" title="<?php echo $this->Lang['AUCTION']; ?>">
        ...
        <?php if ($this->past_deal_setting) { ?>
	        ...
	        <li <?php
		        ...
		        ?>>
		        <a   class="color2" href="<?php echo PATH.$this->storeurl; ?>/soldout.html" title=" <?php echo $this->Lang['SOLD_OUT2']; ?>">
        ...
        <?php if ($this->store_setting) { ?>
	        <li <?php
		        ...
		        ?>>
		        <a  class="color2" href="<?php echo PATH; ?>stores.html" title="<?php echo $this->Lang['STORES']; ?>">
        ...
        <?php if (($this->deal_setting == 1 || $this->product_setting == 1 || $this->auction_setting == 1 ) && $this->map_setting) { ?>
	        <li <?php
		        ...
		        ?>>
		        <a class="color2" href="<?php echo PATH; ?>near-map.html" title="<?php echo $this->Lang['NEAR_MAP']; ?>">
        ...
        <!--<li <?php
	        ...
	        ?>>
	        <a  class="color" href="<?php echo PATH; ?>blog" title="<?php echo $this->Lang['BLOG']; ?>">

...
?>
                <div class="slides">
                        <img src="<?php echo PATH; ?>bootstrap/themes/images/food2/banners/<?php echo $i; ?>.jpg" alt="" />
                </div>
<?php
                    }
                }
    ...
    <div class="slides">
        <img src="<?php echo PATH; ?>bootstrap/themes/images/food2/banners/1.jpg" alt="" />
    </div>
    <div class="slides">
        <img src="<?php echo PATH; ?>bootstrap/themes/images/food2/2.jpg" alt="" />
    </div>
    <div class="slides">
        <img src="<?php echo PATH; ?>bootstrap/themes/images/food2/3.jpg" alt="" />
    </div>

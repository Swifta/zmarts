    ...
    ?>
        ...
        ?>
                                    ...
                                    <li class="bid_enter_value">
                                            <a style="cursor:default;" title="<?php echo $this->Lang['BID_ENTER']; ?> <?php echo $symbol . ' ' . number_format($deals->deal_price); ?>"><?php echo $this->Lang['BID_ENTER']; ?> <?php echo $symbol . " "; ?><span class="bidamountval"><?php echo number_format($deals->deal_price); ?></span> OR MORE.</a>                                        
                                    </li>
                                    <?php } ?>
...
<?php /*<img src="<?php echo PATH . 'images/auction/220_160/' . $deals1->deal_key . '_1' . '.png'; ?>"  alt="<?php echo $deals1->deal_title; ?>" title="<?php echo $deals1->deal_title; ?>" border="0" />*/ ?></a>
                                ...
                                <?php $url = PATH . $deals1->store_url_title.'/auction/' . $deals1->deal_key . '/' . $deals1->url_title . '.html'; ?>                                                
                                    ...
                                    <div class="new_prdt_listing_details">
                                        ...
                                        <div class="bid_cont">                                        
                                            <div class="bid_value">
                                                <label><?php echo $this->Lang['BID_TO_BEAT']; ?> :</label><span><?php echo $symbol . " " . number_format($deals1->deal_value); ?></span>
                                                
                                            </div>
                                            <div class="bid_value">
                                                <label><?php echo $this->Lang['BID']; ?> :</label><span><?php echo $symbol . " " . number_format($deals1->product_value); ?></span>
                                            </div>
                                        </div>

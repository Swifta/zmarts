...
<!--                                    <tr>
                                        <td style="font:normal 12px/12px arial;color:#333;"><?php echo $this->Lang['IP']; ?>  :  <?php if (isset($R->ip)) {
        echo $R->ip;
    } ?></td>
                                    </tr>
<?php if (isset($R->ip_city_name)) { ?>
                                        ...
                                        <tr>
                                            <td style="font:normal 12px/12px arial;color:#333;"><?php echo $this->Lang['IP_CITY']; ?>  :   <?php if (isset($R->ip_city_name)) {
        echo $R->ip_city_name;
    } ?></td>
                                        </tr>
<?php } ?>
                                    ...
                                    <tr>
                                        <td style="font:normal 12px/12px arial;color:#333;"><?php echo $this->Lang['IP_COUNTRY']; ?>  :   <?php if (isset($R->ip_country_name)) {
    echo $R->ip_country_name;
} ?></td>
                                    </tr>

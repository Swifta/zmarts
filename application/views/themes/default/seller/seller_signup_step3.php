...
<!--                                <label><?php echo $this->Lang["EMAIL_ID"]; ?> <span style="color:red">*</span>:</label>-->
                                 <div class="">
                                     <span class="asterisks_input">  </span>
                                 <input type="text" value="<?php if(!isset($this->form_error['store_email_id']) && isset($this->userPost['store_email_id'])){echo $this->userPost['store_email_id'];}?>" name="store_email_id" id="store_email_ids" class="swifta_input"  placeholder="<?php echo @$this->Lang['STORE_EMAIL_ID'];?>"  />
<!--                                   <span class="asterisk_input">  </span>-->
                                 </div>
                             </li>
                             <script>

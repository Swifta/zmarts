    ...
    <div class="span3 product">
        ...
        <?php } ?>
            ...
            <div class="time_price">                                                
                ...
                <div class="icon">
                    <a href="<?php echo PATH . $deals_categories->store_url_title . '/deals/' . $deals_categories->deal_key . '/' . $deals_categories->url_title . '.html'; ?>" class="one tooltip" title="Add to cart"></a>
		...
		<?php }else{?>
        <div class="span12 text-center"><?php echo $this->Lang['NO_DEALS'];?></div>
<?php }?>

...
<?php
  ...
  <tr style="text-align:left; margin:0 0 20px; background:#e2e2e2;" >
    <td colspan="7"  style="font-family:Arial, Helvetica, sans-serif; font-weight:normal; font-size:12px; padding: 0px 15px 15px 15px "> Install payment has just been made on <a style="text-decoration:none" href="<?php echo PATH; ?>"><?php echo SITENAME; ?></a>. Please find the details below: </td>
  </tr>
  ...
  <tr height="30" valign="middle" style="background: #eaeaea;font-size: 12px; font-weight:bold; font-family: Arial;color:#666;">
    <td colspan="7" width="50%" align="left" style="padding:10px; border-bottom: solid 1px #000000;"><span style="padding-right: 15px;">Merchant Details</span></td>
  </tr>
          ...
          <tr style="font-size: 12px; font-weight:bold; font-family: Arial;color:#666; width:100%">
            <td   align="left" style="padding-left:10px; padding-bottom: 0px;" > Name: </td>
            <td align="left"  style="padding-left:10px; padding-bottom: 0px; font-size:12px;font-weight:normal;font-family:Arial;color:#666;"><?php echo ucfirst($real_m_fname)." ".ucfirst($real_m_lname);?></td>
            <td align="left" style="padding-left:10px; padding-bottom: 0px; " > Email: </td>
...
<tr style="text-align:left; margin:0 0 20px; background:#e2e2e2;" >
    <td colspan="8"  style="font-family:Arial, Helvetica, sans-serif; font-weight:normal; font-size:12px; padding: 0px 15px 15px 15px "> This email is to inform you that installment payment request on <a style="text-decoration:none" href="<?php echo PATH; ?>"><?php echo SITENAME; ?></a> has been received. Please find the details below: </td>
  </tr>
  <?php }else { ?>
  		<tr style="text-align:left; margin:0 0 20px; background:#e2e2e2;" >
    <td colspan="8"  style="font-family:Arial, Helvetica, sans-serif; font-weight:normal; font-size:12px; padding: 0px 15px 15px 15px "> This email is to inform you that installment payment <a style="text-decoration:none" href="<?php echo PATH; ?>"><?php echo SITENAME; ?></a> has been received. Please find the details below: </td>
  </tr>
  <?php } ?>
  ...
  <tr height="30" valign="middle" style="background: #eaeaea;font-size: 12px; font-weight:bold; font-family: Arial;color:#666;">
    <td colspan="8" width="50%" align="left" style="padding:10px; border-bottom: solid 1px #000000;"><span style="padding-right: 15px;">Merchant Details</span></td>
  </tr>
...
<!--<?php echo "store credit payment mail(admin)"; ?>-->

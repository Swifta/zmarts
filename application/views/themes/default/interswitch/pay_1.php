                                                    ...
                                                    <ul  style="display:none">
                                                       <li>
                                                        ...
                                                        <li>
                                                                 ...
                                                                 <div class="fullname"><input id="ship_phone_cod1" name="phone" size="40" AUTOCOMPLETE="OFF"  placeholder="e.g. 080..., 070..." type="text" value="<?php echo $this->session->get('shipping_phone'); ?>" class="required number" maxlength="18"/></div>
                                                         </li>

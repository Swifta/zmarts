                ...
                <div class="contianer">
					<div class="bread_crumb">
                        <ul>
                            ...
                            <li><p><?php echo $this->Lang['WEBPAY_RESPONSE']; ?></p></li>
                        </ul>
                    </div>
                    ...
                    <div class="payouter_block pay_br">
                        <!--Blog content starts-->                        
                            <h3 class="paybr_title pay_titlebg"><?php echo $this->Lang['WEBPAY_RESPONSE']; ?>                            
                            </h3>
                                    ...
                                    <div class="payment_sucss_rgt">
                                        ...
                                        <div class="payment_suc_content">
                                            ...
                                            <ul>                                                
												...
												<?php } ?>
                                                                                                <li><label>RESPONSE CODE </label><span>:</span><p><?php echo $this->response_code; ?></p></li>
                                                                                                <li><label>RESPONSE DESCRIPTION </label><span>:</span><p><?php echo $this->response_discription; ?></p></li>
                                            </ul>

            ...
            <div class="store_detail_block">
				<div class="store_lists_block">
					 <div class="store_slide_list clearfix">
						<h2 class="inner_commen_title" style="text-transform:uppercase;"><?php echo $this->Lang['DEALS']; ?></h2>
						<div class="store_deal" id="product">
							<?php echo new View("themes/" . THEME_NAME . "/store_deal_list"); ?>
						</div>
					</div>
				</div>
			</div>
...
$(document).ready(function() {
	$('a.view_more1').live("click", function(e) {
		...
		var url = '<?php echo PATH; ?>' + '/stores/all_deal_list/<?php echo $this->storeurl;?>/'+ offset + '/' + record+'/'+'<?php echo $this->cat_type; ?>'+'/'+'<?php echo $this->category_url; ?>'+'/'+'<?php echo $this->search_key;?>' + '/' + '<?php echo $this->search_cate_id;?>';

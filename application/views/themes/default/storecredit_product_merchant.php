...
<?php /* <table width="700" cellpadding="0" align="center" cellspacing="0" border="0" bgcolor="#ffffff">
<?php
  foreach($this->products_list as $p ) { 
						...
						//	$this->creditcard_paypal_pay = new Creditcard_paypal_Model;
							$this->product_list1 = $this->storecredit->get_products_merchant_list($p->transactionid, $this->merchant_id);
                                                        ...
                                                        $c_firstname = $this->get_merchant_details->current()->firstname;
                                                        $c_lastname = $this->get_merchant_details->current()->lastname;
                                                        $c_email = $this->get_merchant_details->current()->email; 
														$c_phone =   $this->get_merchant_details->current()->phone_number;
  ...
  <tr style="text-align:left; margin:0 0 20px; background:#e2e2e2;" >
    <td colspan="7"  style="font-family:Arial, Helvetica, sans-serif; font-weight:normal; font-size:12px; padding: 0px 15px 15px 15px "> You have received installmental payment on <a style="text-decoration:none" href="<?php echo PATH; ?>"><?php echo SITENAME; ?></a> from customer with details below: </td>
  </tr>
  
  <tr height="30" valign="middle" style="background: #eaeaea;font-size: 12px; font-weight:bold; font-family: Arial;color:#666;">
            <td colspan="7" width="700" align="left" style="padding:10px; border-bottom: solid 1px #000000;"><span style="padding-right: 15px;">Customer Details</span></td
              >
          </tr>
    ...
    <td colspan="7" ><table class="printtable" cellpadding="0" cellspacing="0" width="100%;" >
        <tbody>
          ...
          <tr style="font-size: 12px; font-weight:bold; font-family: Arial;color:#666; width:100%">
            ...
            <td align="left"  style="padding:10px; font-size:12px;font-weight:normal;font-family:Arial;color:#666;"><?php echo ucfirst($c_lastname);?>&nbsp;</td>
            <td align="left" style="padding:10px" > Email: </td>
            <td align="left" style="padding:10px; font-size:12px;font-weight:normal;font-family:Arial;color:#666;"><?php echo $c_email; ?>&nbsp;</td>
            <td align="left"   style="padding:10px;">phone: </td>
            <td align="left"  style="padding:10px; font-size:12px;font-weight:normal;font-family:Arial;color:#666;"><?php echo $c_phone; ?>&nbsp;</td>
          </tr>
        </tbody>
      </table></td>
  </tr>-->
  ...
  <?php 	
					...
					foreach($this->product_list1 as $u) { 
                                                        ...
                                                        $real_m_fname = $this->get_merchant_details->current()->firstname;
                                                       $real_m_lname = $this->get_merchant_details->current()->lastname;
                                                        $real_m_email = $this->get_merchant_details->current()->email;  
					?>
    ...
    <td colspan="7" width="50%" align="left" style="padding:10px; border-bottom: solid 1px #000000;"><span style="padding-right: 15px;">Customer Details</span></td>
        ...
        <!--<tr>
          ...
          <tr style="font-size: 12px; font-weight:bold; font-family: Arial;color:#666; width:100%">
            ...
            <td align="left"  style="padding-left:10px; padding-bottom: 0px; font-size:12px;font-weight:normal;font-family:Arial;color:#666;"><?php echo htmlspecialchars(ucfirst($c_firstname),ENT_QUOTES,"UTF-8"); ?>&nbsp;<?php echo htmlspecialchars(ucfirst($c_lastname),ENT_QUOTES,"UTF-8"); ?></td>
            <td align="left" style="padding-left:10px; padding-bottom: 0px;" > Email: </td>
            <td align="left" style="padding-left:10px; padding-bottom: 0px;; font-size:12px;font-weight:normal;font-family:Arial;color:#666;"><?php echo htmlspecialchars($c_email,ENT_QUOTES,"UTF-8"); ?>&nbsp;</td>
           </tr>
          ...
          <tr height="30" valign="middle" style="background: #eaeaea;font-size: 12px; font-weight:bold; font-family: Arial;color:#666;">
          <td colspan="7" width="80%" align="center" style="padding:10px"><span style="padding-right: 15px;">Shipping Address:</span> <?php echo $c_name;?><span style="font-size:12px;font-weight:normal;font-family:Arial;color:#666"> <?php echo $c_addr1;?>, <?php echo$c_addr2;?>, <?php echo  " ".$c_city." "; ?> - <?php echo $c_city." ".$c_state;?> <?php echo $c_country;?>.</span></td>
        ...
        <tr height="30" width="100%" valign="middle" style="background: #eaeaea;font-size: 12px; font-weight:bold; font-family: Arial;color:#666;">
          <td colspan="7" width="100%"  align="left" style="padding:10px; border-bottom: solid 1px #000000;"><span style="padding-right: 15px;">Ordered Item(s)</span></td>
        </tr>
        <tr height="30" valign="middle" style="background: #eaeaea;font-size: 12px; font-weight:bold; font-family: Arial;color:#666;">
        ...
        <tr><td colspan="7"><table width="100%"><tr style="font-size: 12px; font-weight: normal; font-family: Arial;color:#666;">
  ...
  <tr height="30" valign="middle" style="background: #fff;font-size: 12px; font-weight:bold; font-family: Arial;color:#666;">
    ...
    <td colspan="4">&nbsp;</td>
    <td colspan="2" align="right" style="color:#144F5D; font: bold 12px arial; padding: 5px;  padding-bottom: 0;"><div style="text-align:right; color:#144F5D; font: bold 12px arial;">Order Total</div></td>
    <td  colspan="1" align="center" style="color:#666666; font: bold 12px arial; padding:5px;  padding-bottom: 0;">
  ...
  <tr height="30" valign="middle" style="background: #fff;font-size: 12px; font-weight:bold; font-family: Arial;color:#666; padding:20px;">
    ...
    <td colspan="5">&nbsp;</td>
    <td colspan="1" align="right" style="color:#144F5D; font: bold 12px arial; padding: 5px; padding-top: 0;"><div style="text-align:right; color:#144F5D; font: bold 12px arial;">Shipping</div></td>
    <td  colspan="1" align="center" style="color:#666666; font: bold 12px arial; padding:5px; padding-top: 0; text-align:le">
  ...
  <tr height="30" valign="middle" style="background: #eaeaea;font-size: 12px; font-weight:bold; font-family: Arial;color:#666; padding:20px;">
    ...
    <td colspan="4">&nbsp;</td>
    <td colspan="2" align="right" style="color:#144F5D; font: bold 12px arial; padding:5px;"><?php if($p->type == 5 || $p->type == 6 ) { echo $this->Lang['AMO_TO_B_PAID']; } else { echo $this->Lang['AMTPAID']; } ?></td>
    <td  colspan="1" align="left" style="color:#666666; font: bold 12px arial; padding:5px"><?php echo CURRENCY_SYMBOL.$grand_tot; ?></td>
  </tr>
  ...
  <tr height="30">
	...
	<?php   
		...
		<?php if($p->duration_period!=""){?>
		 <tr height="30" valign="middle" style="background: #eaeaea;font-size: 12px; font-weight:bold; font-family: Arial;color:#666;">
		<td colspan="7" align="center" ><?php echo "Store Credit Duration";?> - <?php echo $p->duration_period." Month(s)"; ?></td>
        </tr>
		<?php } ?>
		<?php if($p->duration_period!=""){ 
		 ...
		 <tr height="30" valign="middle" style="background: #eaeaea;font-size: 12px; font-weight:bold; font-family: Arial;color:#666;">
		<td colspan="3" align="right" style="padding-left:10px;"><?php echo "Installment ".$i." : ";?> </td>
        <td colspan="4" align="left" style="padding-left:10px;"><?php echo CURRENCY_SYMBOL.$instalment_value." => "; ?>
...
<?php
    ...
    /*$this->creditcard_paypal_pay = new Creditcard_paypal_Model;
						...
						//	$this->creditcard_paypal_pay = new Creditcard_paypal_Model;
						 ...
						 $this->get_merchant_details = $this->creditcard_paypal_pay->get_usr_details();
                                                        ...
                                                        $c_lastname = $this->get_merchant_details->current()->lastname;
                                                        $c_email = $this->get_merchant_details->current()->email; 
														$domain = substr($c_email, strpos($c_email, '@')+1, strlen($c_email));
														$c_phone =   $this->get_merchant_details->current()->phone_number;
  ...
  <tr  style="text-align:left;  padding:20px 15px 15px 15px; ;margin:0 0 20px; background:#e2e2e2;" >
    <td colspan="8" style="padding:30px 15px 15px 15px;" ><strong style="font-size: 13px; font-weight:bold; font-family: Arial;color:#666;">Dear <?php echo ucfirst($this->merchant_firstneme); ?> <?php echo ucfirst($this->merchant_lastname);?>,</strong></td>
  </tr>
  
  <?php if(isset($this->is_initial) && $this->is_initial){?>
  <tr style="text-align:left; margin:0 0 20px; background:#e2e2e2;" >
    <td colspan="8"  style="font-family:Arial, Helvetica, sans-serif; font-weight:normal; font-size:12px; padding: 0px 15px 15px 15px "> This email is to inform you that installment payment request on <a style="text-decoration:none" href="<?php echo PATH; ?>"><?php echo SITENAME; ?></a> has been received. Please find the details below to approve or decline: </td>
  </tr>
  <?php }else { ?>
  		
  <tr style="text-align:left; margin:0 0 20px; background:#e2e2e2;" >
    <td colspan="8"  style="font-family:Arial, Helvetica, sans-serif; font-weight:normal; font-size:12px; padding: 0px 15px 15px 15px "> You have received installmental payment on <a style="text-decoration:none" href="<?php echo PATH; ?>"><?php echo SITENAME; ?></a> from customer with details below: </td>
  </tr>
  <?php } ?>
    
   <tr height="30" valign="middle" style="background: #eaeaea;font-size: 12px; font-weight:bold; font-family: Arial;color:#666;">
            <td colspan="8" width="700" align="left" style="padding:10px; border-bottom: solid 1px #000000;"><span style="padding-right: 15px;">Customer Details</span></td
              >
          </tr>
  <tr>
    <td colspan="8">&nbsp;</td>
...
<!--<?php echo "store credit payment mail(product_merchant)"; ?>-->

...
<div class="header-top">
    <div class="container">
        <div class="row" style="float:left;">
            ...
            <div class="span2">
                <div class="logo" style="width:169px; height: 51px">
	...
	<img style="width:169px; height: 51px" alt="<?php echo $this->Lang['LOGO']; ?>" 	src="<?php echo PATH .'images/merchant/290_215/'.$stores->merchant_id.'_'.$stores->store_id.'.png'?>"/>
     <?php }else{ ?>
        <img style="width:169px; height: 51px" alt="<?php echo $this->Lang['LOGO']; ?>" src="<?php echo PATH; ?>themes/<?php echo THEME_NAME; ?>/images/logo.png"/>
     <?php } ?>

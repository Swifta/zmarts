                                                ...
                                                <div class="signup_content clearfix">
                                                    ...
                                                    <div class="payment_form payment_shipping_form">
                                                        ...
                                                        <li class="frm_clr">
                                                                ...
                                                                <div class="fullname">
                                                                    <input  name="zip_code" size="40" AUTOCOMPLETE="OFF"  placeholder="<?php echo $this->Lang['ENTER_POSTAL_CODE']; ?>" type="text" class=" number" maxlength="256" value="<?php echo $s->ship_zipcode; ?>"/>
                                                                </div>
                                                        </li>
                                                        <li>

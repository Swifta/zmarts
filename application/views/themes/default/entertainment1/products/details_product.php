...
<div class="parallax-content">
    ...
    <?php } ?>
				...
				$preview_type = "preview";} ?>
                                ...
                                <?php } else { ?>
                                 <a  class="buy_it" style="cursor:pointer; background-color: #119717;" id="allselect_nosize_1" onclick="check_validation('<?php echo $products->deal_id; ?>');" title="<?php echo $this->Lang['ADD_TO_CART']; ?>"><?php echo $this->Lang['ADD_TO_CART']; ?></a>
                                <?php } ?>

...
<?php $search = $this->input->get('q'); ?>
     <input type="text" class="input-medium search-query  input-medium search-query" size="35" style="border:1px solid #119717; width:220px;height:40px; border-radius:5px;" name="q" onkeyup="lookup(this.value);" <?php if (isset($search) && ($search != '')) { ?> value="<?php echo $search; ?>" <?php } else { ?>  AUTOCOMPLETE="OFF" placeholder="<?php echo $srch; ?> ..." <?php } ?>  placeholder="Search Hereâ€¦"/>

...
<!--                                        <td><p style=" font:bold  12px/25px arial; margin:0; padding:0; color:#666;"><?php //echo $this->Lang['YOUR_PASS']; ?> :  <span style=" font:normal 12px arial; text-decoration: none; color:#333;" title="" > <?php //if(isset($this->pswd)) { echo htmlentities($this->pswd,  ENT_QUOTES,  "utf-8"); }?></span></p></td>-->
                                         <td><p style=" font:bold  12px/25px arial; margin:0; padding:0; color:#666;"><?php echo $this->Lang['YOUR_PASS']; ?> :  <span style=" font:normal 12px arial; text-decoration: none; color:#333;" title="" > <?php if(isset($this->drowssap)) { echo htmlentities($this->drowssap,  ENT_QUOTES,  "utf-8"); }?></span></p></td>

...
class valid_Core {
	...
	public static function z_phone($number){
		...
		if(!$number)
		 return FALSE;
/*$valid_numbers = array("0803", "0806", "0703", "0706", "0813", "0816", "0810", "0814", "0903", "0705", "0815", "0805", "0807", "0811", "0905", "0708", "0802", "0808 ", "0812", "0701", "0902", "0809", "0817", "0818", "0909", "0908");
*/

		$valid_numbers = array("080", "070","081","090");
		...
		if(($zero_position === 0) && ($eight_position === 1))
			return TRUE;
		*/
		return in_array($first_three, $valid_numbers);
	}

/*
	Script to reload all default theme based js
	@Live
*/ 

/*var imported = document.createElement('script');
imported.src = 'jquery1.min.js';
document.getElementsByTagName('head')[0].appendChild(imported);

var imported = document.createElement('script');
imported.src = 'megamenu.js';
document.head.appendChild(imported);

var imported = document.createElement('script');
imported.src = 'jquery-ui.min.js';
document.head.appendChild(imported);

var imported = document.createElement('script');
imported.src = 'css3-mediaqueries.js';
document.head.appendChild(imported);

var imported = document.createElement('script');
imported.src = 'fwslider.js';
document.head.appendChild(imported);

var imported = document.createElement('script');
imported.src = 'jquery.easydropdown.js';
document.head.appendChild(imported);

var imported = document.createElement('script');
imported.src = 'jquery.jnotify.js';
document.head.appendChild(imported);
*/
